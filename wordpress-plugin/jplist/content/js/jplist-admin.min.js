/*
 jPList - jQuery Data Grid Controls 0.0.44 - http://jplist.com 
...
jQuery.ajax({url:g.attr("data-url"),type:"POST",data:{js:b,top:f,bot:c,template:d,action:"save_changes"}}).done(function(a){}).fail(function(){}).always(function(){h.hide()})})};jQuery(document).ready(function(){var a={topPanel:null,bottomPanel:null,jsSettings:null,handlebarsTemplate:null};-1!==window.location.href.indexOf("jplist.php")&&(window.CodeMirror&&(a.jsSettings=window.CodeMirror(document.getElementById("js-settings-bar-ta"),{mode:"text/typescript",extraKeys:{"Ctrl-Space":"autocomplete"},
...
window.CodeMirror(document.getElementById("handlebars-template-bar-ta"),{mode:"text/html",extraKeys:{"Ctrl-Space":"autocomplete"},value:jQuery("#handlebars-template-bar-ta-content").html(),lineNumbers:!0,lineWrapping:!0})),k(a))})})();
