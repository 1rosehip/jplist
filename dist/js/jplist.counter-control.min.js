...
a.$control.data("$countValue",b));c&&(b=new jQuery.fn.jplist.DataItemMemberPathModel(c,null),a.$control.data("path",b));a.$control.data("dataMode",e);a.$control.data("dataType",g);a.$control.data("dataPath",c);a.$control.data("dataText",d);a.$control.data("dataMin",f);a.$control.data("dataMax",h);l(a);return jQuery.extend(this,a)};k.prototype.getPaths=function(a){var b,c;b=this.$control.attr("data-path");c=this.$control.attr("data-type");b&&(b=new jQuery.fn.jplist.DataItemMemberPathModel(b,c),a.push(b))};
jQuery.fn.jplist.controls.Counter=function(a){return new k(a)};jQuery.fn.jplist.controlTypes.counter={className:"Counter",options:{ignore:"[~!@#$%^&*()+=`'\"/\\_]+"}}})();
