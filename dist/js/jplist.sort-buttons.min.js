...
(b=g(a),f=new jQuery.fn.jplist.controls.SortButtonDTO(b.attr("data-path"),b.attr("data-type"),b.attr("data-order"),b.attr("data-datetime-format"),b.attr("data-ignore"),!0),d.push(f));return b=new jQuery.fn.jplist.StatusDTO(a.name,a.action,a.type,new jQuery.fn.jplist.controls.SortButtonsGroupDTO(d),a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking)},k=function(a,c){a.params.$buttons.each(function(){var a,d=jQuery(this);a=d.attr("data-path");d=d.attr("data-type");a=new jQuery.fn.jplist.DataItemMemberPathModel(a,
