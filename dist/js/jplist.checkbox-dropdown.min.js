...
""};k(a);new jQuery.fn.jplist.DropdownControl(a.options,a.observer,a.history,a.$control);a.params.$panel=a.$control.find(".jplist-dd-panel");n(a);a.params.$panel.text(l(a));return jQuery.extend(this,a)};h.prototype.getStatus=function(a){return g(this,a)};h.prototype.getDeepLink=function(){var a="",d,b="";if(this.inDeepLinking&&(d=g(this,!1),d.data&&jQuery.isArray(d.data.pathGroup)&&0<d.data.pathGroup.length)){for(a=0;a<d.data.pathGroup.length;a++)""!==b&&(b+=this.options.delimiter2),b+=d.data.pathGroup[a];
