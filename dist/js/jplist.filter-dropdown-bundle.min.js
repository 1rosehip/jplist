...
c=jQuery(this).attr("data-type");d&&""!==jQuery.trim(d)&&(e=new jQuery.fn.jplist.DataItemMemberPathModel(d,c),b.push(e))})},g=function(a,b){var d;d=a.$control.find("li");d.removeClass("active");if(!b||0>=b.length)b=d.eq(0);0<b.length&&(b.addClass("active"),a.$control.find(".jplist-dd-panel").text(b.eq(0).text()))},f=function(a){a.$control.find("li").off("click").on("click",function(){var b;b=jQuery(this);g(a,b);b=e(a,!1);a.observer.trigger(a.observer.events.knownStatusesChanged,[[b]])})},c=function(a){new jQuery.fn.jplist.DropdownControl(a.options,
...
d=jQuery(this).attr("data-type");b&&(e=new jQuery.fn.jplist.DataItemMemberPathModel(b,d),a.push(e))})},g=function(c){c.$control.change(function(){var a,b,d;a=e(c,!1);b=jQuery(this).find("option:selected");d=b.attr("data-path");b=b.attr("data-number");d?(a.data.path=d,a.data.type=jQuery(this).attr("data-type"),a.data.order=jQuery(this).attr("data-order")):b&&(a.data.number=b);c.observer.trigger(c.observer.events.knownStatusesChanged,[[a]])})},f=function(c){g(c);return jQuery.extend(this,c)};f.prototype.getStatus=
