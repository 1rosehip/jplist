...
c=jQuery(this).attr("data-type");d&&""!==jQuery.trim(d)&&(e=new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(d,c),b.push(e))})},g=function(a,b){var d;d=a.$control.find("li");d.removeClass("active");if(!b||0>=b.length)b=d.eq(0);0<b.length&&(b.addClass("active"),a.$control.find(".jplist-dd-panel").text(b.eq(0).text()))},f=function(a){a.$control.find("li").off("click").on("click",function(){var b;b=jQuery(this);g(a,b);b=e(a,!1);a.observer.trigger(a.observer.events.knownStatusesChanged,
