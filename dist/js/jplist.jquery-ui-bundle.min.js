/**
* jPList - jQuery Data Grid Controls 5.2.0.4 - http://jplist.com 
...
"next"&&(e=b.split(this.options.delimiter2),2===e.length&&(c.data.prev=e[0],c.data.next=e[1])));return c};e.prototype.getPaths=function(a){var b;this.params.dataPath&&(b=new jQuery.fn.jplist.DataItemMemberPathModel(this.params.dataPath,"number"),a.push(b))};e.prototype.setStatus=function(a,b){var c,d;jQuery.isNumeric(a.data.prev)&&jQuery.isNumeric(a.data.next)&&(c=Number(a.data.prev),d=Number(a.data.next),isNaN(c)||isNaN(d)||(this.params.$uiSlider.slider("values",0)!=c&&this.params.$uiSlider.slider("values",
0,c),this.params.$uiSlider.slider("values",1)!=d&&this.params.$uiSlider.slider("values",1,d)));this.params.controlOptions&&this.params.uiSetValuesFunc(this.params.$uiSlider,this.params.$prev,this.params.$next)};jQuery.fn.jplist.controls.RangeSlider=function(a){return new e(a)};jQuery.fn.jplist.controlTypes["range-slider"]={className:"RangeSlider",options:{}}})();
