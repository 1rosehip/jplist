...
a.action,a.type,b,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking)},g=function(a){a.$control.on("click","li",function(){var c,b=null;c=Number(jQuery(this).attr("data-number"))||0;b=e(a,!1);b.data.currentPage=c;a.observer.trigger(a.observer.events.knownStatusesChanged,[[b]])})},f=function(a){a.params={view:new jQuery.fn.jplist.ui.controls.BootstrapPaginationView(a.$control,a.controlOptions)};g(a);return jQuery.extend(this,a)};f.prototype.getStatus=function(a){return e(this,a)};f.prototype.getDeepLink=
...
function(b){var d;b.preventDefault();d=g(a,!1);if(b=jQuery(this).attr("data-number"))d.data.number=b;a.observer.trigger(a.observer.events.knownStatusesChanged,[[d]])})},a=function(a){a.params={$textBox:a.$control.find('[data-type="selected-text"]'),$buttons:a.$control.find("[data-number]")};f(a);return jQuery.extend(this,a)};a.prototype.getStatus=function(a){return g(this,a)};a.prototype.getDeepLink=function(){var a="",b;this.inDeepLinking&&(b=g(this,!1),b.data&&(jQuery.isNumeric(b.data.number)||
