...
*/
(function(){jQuery.fn.jplist.controls.BootFilterDropdownDTO=function(e){return{path:e,filterType:"path"}}})();(function(){var e=function(a){var b;b=a.params.$buttons.filter('[data-default="true"]').eq(0);0>=b.length&&(b=a.params.$buttons.eq(0));return b},f=function(a,b){var c=null,c=b?e(a):a.params.$buttons.filter('[data-jplist-selected="true"]'),c=new jQuery.fn.jplist.controls.BootFilterDropdownDTO(c.attr("data-path"));return c=new jQuery.fn.jplist.StatusDTO(a.name,a.action,a.type,c,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking)},g=function(a,b){b&&0<b.length&&(a.params.$buttons.attr("data-jplist-selected",
!1),b.attr("data-jplist-selected",!0),a.params.$textBox.text(b.text()))},h=function(a,b){var c,d;a.params.$buttons.each(function(){var a=jQuery(this);(c=a.attr("data-path"))&&""!==jQuery.trim(c)&&(d=new jQuery.fn.jplist.DataItemMemberPathModel(c,a.attr("data-type")),b.push(d))})},k=function(a){a.params.$buttons.on("click",function(b){var c=jQuery(this);b.preventDefault();g(a,c);b=f(a,!1);a.observer.trigger(a.observer.events.knownStatusesChanged,[[b]])})},d=function(a){a.params={$textBox:a.$control.find('[data-type="selected-text"]'),
