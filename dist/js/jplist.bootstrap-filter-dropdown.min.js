...
!1),b.attr("data-jplist-selected",!0),a.params.$textBox.text(b.text()))},h=function(a,b){var c,d;a.params.$buttons.each(function(){var a=jQuery(this);(c=a.attr("data-path"))&&""!==jQuery.trim(c)&&(d=new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(c,a.attr("data-type")),b.push(d))})},k=function(a){a.params.$buttons.on("click",function(b){var c=jQuery(this);b.preventDefault();g(a,c);b=f(a,!1);a.observer.trigger(a.observer.events.knownStatusesChanged,[[b]])})},d=function(a){a.params={$textBox:a.$control.find('[data-type="selected-text"]'),
