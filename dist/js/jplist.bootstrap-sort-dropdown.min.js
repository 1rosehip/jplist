...
a.inDeepLinking)},g=function(a,c){var b,k,d;a.params.$buttons.each(function(){b=jQuery(this).attr("data-path");k=jQuery(this).attr("data-type");b&&""!==jQuery.trim(b)&&(d=new jQuery.fn.jplist.DataItemMemberPathModel(b,k),c.push(d))})},h=function(a){a.params.$buttons.on("click",function(c){var b=jQuery(this),d;c.preventDefault();c=e(a,!1);if(d=b.attr("data-path"))c.data.path=d,c.data.type=b.attr("data-type"),c.data.order=b.attr("data-order");a.observer.trigger(a.observer.events.knownStatusesChanged,
