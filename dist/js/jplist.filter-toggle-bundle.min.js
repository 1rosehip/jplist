...
function(){var c,b;c=jQuery(this);"multiple"===a.params.mode?(b=c.data("selected")||!1,c.data("selected",!b)):(a.params.$buttons.data("selected",!1),c.data("selected",!0));c=d(a,!1);a.history.addStatus(c);a.observer.trigger(a.observer.events.knownStatusesChanged,[[c]])})},b=function(a){var c;"multiple"===a.params.mode?a.params.$buttons.each(function(){var c=jQuery(this),b;b="true"===c.attr("data-selected");a.options.deepLinking&&(b=!1);c.data("selected",b)}):(a.params.$buttons.data("selected",!1),
c=a.params.$buttons.filter('[data-selected="true"]'),c=0<c.length?c.eq(0):a.params.$buttons.eq(0),c.data("selected",!0),c.attr("data-selected",!0),c.trigger("click"))},c=function(c){c.params={$buttons:c.$control.find("[data-button]"),mode:c.$control.attr("data-mode")||"multiple"};a(c);b(c);return jQuery.extend(this,c)};c.prototype.getStatus=function(a){return d(this,a)};c.prototype.getDeepLink=function(){var a="",c="",b;if(this.inDeepLinking&&(b=d(this,!1),b.data&&b.data.pathGroup&&0<b.data.pathGroup.length)){for(var e=
...
{className:"ButtonFilterGroup",options:{}}})();(function(){var d=function(a,b){var c,h="";(c=b?"true"===a.$control.attr("data-selected"):a.params.selected)&&(h="path");c={path:a.$control.attr("data-path"),filterType:h,selected:c};return new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,c,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking)},f=function(a){a.$control.on("click",function(){var b;a.params.selected=!a.params.selected;b=d(a,!1);a.history.addStatus(b);a.observer.trigger(a.observer.events.knownStatusesChanged,[[b]])})},
e=function(a){a.params={selected:"true"===a.$control.attr("data-selected")};a.options.deepLinking&&(a.params.selected=!1);f(a);return jQuery.extend(this,a)};e.prototype.getStatus=function(a){return d(this,a)};e.prototype.getDeepLink=function(){var a="",b=null;this.inDeepLinking&&(b=d(this,!1),b.data&&b.data.selected&&(a=this.name+this.options.delimiter0+"selected=true"));return a};e.prototype.getStatusByDeepLink=function(a,b){var c=null,h;this.inDeepLinking&&(c=d(this,!1),c.data&&(h="selected"===
a&&"true"===b))&&(c.data.selected=h,c.data.filterType="path");return c};e.prototype.getPaths=function(a){var b;if(b=this.$control.attr("data-path"))b=new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(b,"text"),a.push(b)};e.prototype.setStatus=function(a,b){(this.params.selected=a.data.selected)?this.$control.addClass("jplist-selected"):this.$control.removeClass("jplist-selected")};jQuery.fn.jplist.ui.controls.ButtonFilter=function(a){return new e(a)};jQuery.fn.jplist.controlTypes["button-filter"]=
{className:"ButtonFilter",options:{}}})();(function(){jQuery.fn.jplist.ui.controls.ButtonTextFilterDTO=function(d,f,e,a,b){return{path:d,ignore:e,value:f,selected:a,mode:b,filterType:"TextFilter"}}})();(function(){jQuery.fn.jplist.ui.controls.ButtonTextFilterGroupDTO=function(d,f){return{textAndPathsGroup:d,ignore:f,filterType:"textFilterPathGroup"}}})();(function(){var d=function(a,b){var g,d=[];g=null;g="";a.controlOptions&&a.controlOptions.ignore&&(g=a.controlOptions.ignore);a.params.$buttons.each(function(a,c){var g=jQuery(c),e;e=b?"true"===g.attr("data-selected"):g.data("selected")||!1;d.push({selected:e,text:g.data("dataText"),path:g.data("dataPath"),mode:g.data("dataMode")||"contains"})});g=new jQuery.fn.jplist.ui.controls.ButtonTextFilterGroupDTO(d,g);return g=new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,g,a.inStorage,a.inAnimation,
...
b.data.textAndPathsGroup[e],d=a.params.$buttons.filter('[data-path="'+g.path+'"][data-text="'+g.text+'"]'),0<d.length&&g.selected&&(d.addClass("jplist-selected"),d.data("selected",!0))},a=function(a){var b;a.params.$buttons.on("click",function(){var g=jQuery(this);b=g.data("selected")||!1;g.data("selected",!b);g=d(a,!1);a.history.addStatus(g);a.observer.trigger(a.observer.events.knownStatusesChanged,[[g]])})},b=function(c){c.params={$buttons:c.$control.find("[data-button]")};c.params.$buttons.each(function(){var a=
