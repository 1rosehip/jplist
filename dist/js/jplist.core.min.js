/**
* jPList - jQuery Data Grid Controls 5.2.0.131 - http://jplist.com 
...
storage:"",storageName:"jplist",cookiesExpiration:-1,deepLinking:!1,hashStart:"#",delimiter0:":",delimiter1:"|",delimiter2:"~",delimiter3:"!",historyLength:10,dataSource:{type:"html",server:{ajax:{url:"server.php",dataType:"html",type:"POST"},serverOkCallback:null,serverErrorCallback:null},render:null}},b);a.observer=new jQuery.fn.jplist.PubSub(a.$root,a.options);a.history=new jQuery.fn.jplist.History(a.$root,a.options,a.observer);a.panel=new jQuery.fn.jplist.PanelController(c,a.options,a.history,
a.observer);a.storage=new jQuery.fn.jplist.Storage(a.options.storage,a.options.storageName,a.options.cookiesExpiration);a.options.dataSource=a.options.dataSource||{};a.options.dataSource.type=a.options.dataSource.type||"html";jQuery.fn.jplist.info(a.options,"Data Source Type: ",a.options.dataSource.type);switch(a.options.dataSource.type){case "html":a.itemControls=new jQuery.fn.jplist.ItemControlCollection(a.options,a.observer,a.history,a.$root);a.controller=new jQuery.fn.jplist.DOMController(a.$root,
a.options,a.observer,a.panel.paths);break;case "server":a.controller=new jQuery.fn.jplist.ServerController(a.$root,a.options,a.observer,a.panel,a.history)}d(a);a.options.deepLinking?(jQuery.fn.jplist.info(a.options,"Deep linking enabled",""),a.panel.setStatusesByDeepLink()):a.panel.setStatusesFromStorage();return jQuery.extend(this,a)};jQuery.fn.jplist=function(d){if(d.command&&"init"!==d.command){var a;if(a=this.data("jplist"))return b(a,d.command,d.commandData)}else return this.each(function(){var b,
a=jQuery(this);b=new e(d,a);a.data("jplist",b)})};jQuery.fn.jplist.controls=jQuery.fn.jplist.controls||{};jQuery.fn.jplist.itemControls=jQuery.fn.jplist.itemControls||{};jQuery.fn.jplist.controlTypes={};jQuery.fn.jplist.itemControlTypes={};jQuery.fn.jplist.settings={};jQuery.fn.jplist.FiltersService=jQuery.fn.jplist.FiltersService||{};jQuery.fn.jplist.SortService=jQuery.fn.jplist.SortService||{}})();(function(){jQuery.fn.jplist.logEnabled=function(a){return a.debug&&window.console&&jQuery.isFunction(window.console.log)};jQuery.fn.jplist.log=function(a,c,b){jQuery.fn.jplist.logEnabled(a)&&window.console.log(c,b)};jQuery.fn.jplist.info=function(a,c,b){jQuery.fn.jplist.logEnabled(a)&&window.console.info(c,b)};jQuery.fn.jplist.error=function(a,c,b){jQuery.fn.jplist.logEnabled(a)&&window.console.error(c,b)};jQuery.fn.jplist.warn=function(a,c,b){jQuery.fn.jplist.logEnabled(a)&&window.console.warn(c,
b)}})();(function(){jQuery.fn.jplist.PubSub=function(a,c){var b={options:c,$root:a,events:{unknownStatusesChanged:"1",knownStatusesChanged:"2",statusesChangedByDeepLinks:"3",listSorted:"4",listFiltered:"5",listPaginated:"6",dataItemAdded:"7",dataItemRemoved:"8",collectionReadyEvent:"9",statusesAppliedToList:"10",animationStartEvent:"11",animationStepEvent:"12",animationCompleteEvent:"13"}};return jQuery.extend(!0,jQuery({}),this,b)}})();(function(){jQuery.fn.jplist.StatusDTO=function(a,c,b,d,e,f,g,h){this.action=c;this.name=a;this.type=b;this.data=d;this.inStorage=e;this.inAnimation=f;this.isAnimateToTop=g;this.inDeepLinking=h}})();(function(){var a=function(a,b){a.statusesQueue.push(b);a.statusesQueue.length>a.options.historyLength&&a.statusesQueue.shift()};jQuery.fn.jplist.History=function(a,b,d){this.options=b;this.observer=d;this.$root=a;this.statusesQueue=[];this.listStatusesQueue=[]};jQuery.fn.jplist.History.prototype.addStatus=function(c){a(this,c)};jQuery.fn.jplist.History.prototype.addStatuses=function(c){for(var b=0;b<c.length;b++)a(this,c[b])};jQuery.fn.jplist.History.prototype.getLastStatus=function(){var a=null;
...
this.options.historyLength&&this.listStatusesQueue.shift()};jQuery.fn.jplist.History.prototype.popList=function(){var a=null;0<this.listStatusesQueue.length&&(a=this.listStatusesQueue.pop());return a}})();(function(){var a=function(b,d,a,c){d=[];for(var g,h=0;h<b.statuses.length;h++)g=b.statuses[h],g[a]===c&&(g.initialIndex=h,d.push(g));return d},c=function(b,d){for(var a=[],c,g=0;g<b.statuses.length;g++)c=b.statuses[g],c.action===d&&a.push(c);return a};jQuery.fn.jplist.Statuses=function(b){this.statuses=b||[]};jQuery.fn.jplist.Statuses.prototype.getStatusesByAction=function(b){return c(this,b)};jQuery.fn.jplist.Statuses.prototype.add=function(b,d){var c,f;if(0===this.statuses.length)this.statuses.push(b);
else if(c=a(this,this.statuses,"action",b.action),0===c.length)this.statuses.push(b);else if(f=a(this,c,"name",b.name),0===f.length)this.statuses.push(b);else for(var g=0;g<f.length;g++)c=f[g],c.type===b.type?d&&(this.statuses[c.initialIndex]=b):(this.statuses[c.initialIndex]=jQuery.extend(!0,{},c,b),this.statuses[c.initialIndex].type="combined")};jQuery.fn.jplist.Statuses.prototype.get=function(b){var a=null;0<=b&&b<this.statuses.length&&(a=this.statuses[b]);return a};jQuery.fn.jplist.Statuses.prototype.toArray=
function(){return this.statuses};jQuery.fn.jplist.Statuses.prototype.getSortStatuses=function(){var b,a,e=[],f;b=c(this,"sort");if(jQuery.isArray(b))for(var g=0;g<b.length;g++)if((a=b[g])&&a.data&&a.data.sortGroup&&jQuery.isArray(a.data.sortGroup)&&0<a.data.sortGroup.length)for(var h=0;h<a.data.sortGroup.length;h++)f=new jQuery.fn.jplist.StatusDTO(a.name,a.action,a.type,a.data.sortGroup[h],a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking),e.push(f);else e.push(a);return e};jQuery.fn.jplist.Statuses.prototype.getFilterStatuses=
function(){var b,a,e,f=[];b=c(this,"filter");if(jQuery.isArray(b))for(var g=0;g<b.length;g++)(a=b[g])&&a.data&&a.data.filterType&&(e=jQuery.fn.jplist.DTOMapperService.filters[a.data.filterType],jQuery.isFunction(e)&&f.push(a));return f}})();(function(){jQuery.fn.jplist.DTOMapperService=jQuery.fn.jplist.DTOMapperService||{};jQuery.fn.jplist.DTOMapperService.filters={};jQuery.fn.jplist.DTOMapperService.filters.TextFilter=function(a,c){var b=new jQuery.fn.jplist.DataItemMemberPathModel(a.data.path,null);return jQuery.fn.jplist.FiltersService.textFilter(a.data.value,b,c,a.data.ignore,a.data.mode)};jQuery.fn.jplist.DTOMapperService.filters.path=function(a,c){var b=new jQuery.fn.jplist.DataItemMemberPathModel(a.data.path,null);return jQuery.fn.jplist.FiltersService.pathFilter(b,
c)};jQuery.fn.jplist.DTOMapperService.filters.range=function(a,c){var b=new jQuery.fn.jplist.DataItemMemberPathModel(a.data.path,null);return jQuery.fn.jplist.FiltersService.rangeFilter(b,c,a.data.min,a.data.max,a.data.prev,a.data.next)};jQuery.fn.jplist.DTOMapperService.filters.date=function(a,c){var b=new jQuery.fn.jplist.DataItemMemberPathModel(a.data.path,null);return jQuery.fn.jplist.FiltersService.dateFilter(a.data.year,a.data.month,a.data.day,b,c,a.data.format)};jQuery.fn.jplist.DTOMapperService.filters.dateRange=
function(a,c){var b=new jQuery.fn.jplist.DataItemMemberPathModel(a.data.path,null);return jQuery.fn.jplist.FiltersService.dateRangeFilter(b,c,a.data.format,a.data.prev_year,a.data.prev_month,a.data.prev_day,a.data.next_year,a.data.next_month,a.data.next_day)};jQuery.fn.jplist.DTOMapperService.filters.pathGroup=function(a,c){return jQuery.fn.jplist.FiltersService.pathGroupFilter(a.data.pathGroup,c)};jQuery.fn.jplist.DTOMapperService.filters.textGroup=function(a,c){return jQuery.fn.jplist.FiltersService.textGroupFilter(a.data.textGroup,
a.data.logic,a.data.path,a.data.ignoreRegex,c,a.data.mode)};jQuery.fn.jplist.DTOMapperService.filters.textFilterPathGroup=function(a,c){return jQuery.fn.jplist.FiltersService.textFilterPathGroup(a.data.textAndPathsGroup,a.data.ignoreRegex,c,a.data.mode)};jQuery.fn.jplist.DTOMapperService.sort={};jQuery.fn.jplist.DTOMapperService.sort.text=function(a,c,b){var d=new jQuery.fn.jplist.DataItemMemberPathModel(a.data.path,a.data.type);return jQuery.fn.jplist.SortService.textHelper(c,b,a.data.order,d,a.data.ignore||
"")};jQuery.fn.jplist.DTOMapperService.sort.number=function(a,c,b){var d=new jQuery.fn.jplist.DataItemMemberPathModel(a.data.path,a.data.type);return jQuery.fn.jplist.SortService.numbersHelper(c,b,a.data.order,d)};jQuery.fn.jplist.DTOMapperService.sort.datetime=function(a,c,b){var d=new jQuery.fn.jplist.DataItemMemberPathModel(a.data.path,a.data.type);return jQuery.fn.jplist.SortService.datetimeHelper(c,b,a.data.order,d,a.data.dateTimeFormat||"")}})();(function(){jQuery.fn.jplist.DataItemMemberPathModel=function(a,c){this.jqPath=a;this.dataType=c};jQuery.fn.jplist.DataItemMemberPathModel.prototype.isEqual=function(a,c){var b=!1;c?this.jqPath===a.jqPath&&(b=!0):this.jqPath===a.jqPath&&this.dataType===a.dataType&&(b=!0);return b}})();(function(){jQuery.fn.jplist.DataItemMemberModel=function(a,c){this.$element=a;this.path=c;this.text=a.text();this.html=a.html()}})();(function(){jQuery.fn.jplist.DataItemModel=function(a,c,b){this.pathitems=[];this.jqElement=this.$item=a;this.index=b;this.html=jQuery.fn.jplist.HelperService.getOuterHtml(a);var d,e;a=[];for(b=0;b<c.length;b++)d=c[b],e=this.$item.find(d.jqPath),0<e.length&&(d=new jQuery.fn.jplist.DataItemMemberModel(e,d),a.push(d));this.pathitems=a};jQuery.fn.jplist.DataItemModel.prototype.findPathitem=function(a){for(var c=null,b,d=0;d<this.pathitems.length;d++)if(b=this.pathitems[d],b.path.isEqual(a,!0)){c=b;break}return c}})();(function(){var a=function(b,a){var d,c,e;d=(new jQuery.fn.jplist.Statuses(a)).getFilterStatuses();if(0<d.length){for(var f=0;f<d.length;f++)c=d[f],e=jQuery.fn.jplist.DTOMapperService.filters[c.data.filterType],b.dataview=e(c,b.dataview);b.observer.trigger(b.observer.events.listFiltered,[a,b])}},c=function(b,a){var d,c=null,e;d=(new jQuery.fn.jplist.Statuses(a)).getStatusesByAction("paging",a);if(0<d.length){for(var f=0;f<d.length;f++)c=d[f],e=c.data.currentPage||0,c=new jQuery.fn.jplist.PaginationService(e,
c.data.number,b.dataview.length),d[f].data.paging=c,b.dataview=jQuery.fn.jplist.FiltersService.pagerFilter(c,b.dataview);b.observer.trigger(b.observer.events.listPaginated,[a,b])}},b=function(b,a){var d=[],d=(new jQuery.fn.jplist.Statuses(a)).getSortStatuses();0<d.length&&(jQuery.fn.jplist.SortService.doubleSort(d,b.dataview),b.observer.trigger(b.observer.events.listSorted,[a,b]))},d=function(b){return jQuery(b.dataview).map(function(b,a){return a.jqElement.get()})},e=function(b){return jQuery(b.dataitems).map(function(b,
a){return a.jqElement.get()})},f=function(b){b.dataview=jQuery.merge([],b.dataitems)},g=function(b,a){for(var d,c=-1,e,f=0;f<b.dataitems.length;f++)if(d=b.dataitems[f],d=jQuery.fn.jplist.HelperService.getOuterHtml(d.jqElement),e=jQuery.fn.jplist.HelperService.getOuterHtml(a),d===e){c=f;break}return c},h=function(b,a){var d;d=g(b,a);-1!==d&&(b.dataitems.splice(d,1),b.observer.trigger(b.observer.events.dataItemRemoved,[a,b.dataitems]))},k=function(b,a){a.each(function(){h(b,jQuery(this))})},l=function(b,
a,d,c){a=new jQuery.fn.jplist.DataItemModel(a,d,c);b.dataitems.splice(c,0,a);b.observer.trigger(b.observer.events.dataItemAdded,[a,b.dataitems])},m=function(b,a,d,c,e){for(var f;d<a.length;d++)f=a.eq(d),3!==f.get(0).nodeType&&(l(b,f,c,d),d+1<a.length&&0===d%50&&window.setTimeout(function(){m(b,a,d,c,e)},0))};jQuery.fn.jplist.Dataitems=function(b,a,d){this.dataitems=[];this.dataview=[];this.paths=d;this.observer=b;0<a.length&&(m(this,a,0,d,0),f(this));this.observer.trigger(this.observer.events.collectionReadyEvent,
[this])};jQuery.fn.jplist.Dataitems.prototype.applyStatuses=function(e){f(this);b(this,e);a(this,e);c(this,e);this.observer.trigger(this.observer.events.statusesAppliedToList,[this,e]);return d(this)};jQuery.fn.jplist.Dataitems.prototype.filter=function(b){a(this,b)};jQuery.fn.jplist.Dataitems.prototype.sort=function(a){b(this,a)};jQuery.fn.jplist.Dataitems.prototype.pagination=function(b){c(this,b)};jQuery.fn.jplist.Dataitems.prototype.dataviewToJqueryObject=function(){return d(this)};jQuery.fn.jplist.Dataitems.prototype.dataitemsToJqueryObject=
function(){return e(this)};jQuery.fn.jplist.Dataitems.prototype.resetDataview=function(){f(this)};jQuery.fn.jplist.Dataitems.prototype.empty=function(){this.dataitems=[];this.dataview=[]};jQuery.fn.jplist.Dataitems.prototype.addDataItem=function(b,a,d){l(this,b,a,d)};jQuery.fn.jplist.Dataitems.prototype.addDataItems=function(b,a,d){m(this,b,0,a,d);f(this)};jQuery.fn.jplist.Dataitems.prototype.delDataitem=function(b){h(this,b)};jQuery.fn.jplist.Dataitems.prototype.delDataitems=function(b){k(this,b)};
jQuery.fn.jplist.Dataitems.prototype.indexOf=function(b){return g(this,b)};jQuery.fn.jplist.Dataitems.prototype.dataviewToString=function(){var b,a="",d;for(d=0;d<this.dataview.length;d++)b=this.dataview[d],a+=b.content;return a}})();(function(){var a=function(a,b){for(var d,e=!1,f=0;f<a.paths.length;f++)if(d=a.paths[f],d.isEqual(b,!0)){e=!0;break}return e};jQuery.fn.jplist.DataItemMemberPathCollection=function(){this.paths=[]};jQuery.fn.jplist.DataItemMemberPathCollection.prototype.add=function(c){a(this,c)||this.paths.push(c)};jQuery.fn.jplist.DataItemMemberPathCollection.prototype.addRange=function(c){for(var b=0;b<c.length;b++){var d=c[b];a(this,d)||this.paths.push(d)}};jQuery.fn.jplist.DataItemMemberPathCollection.prototype.isPathInList=
function(c){return a(this,c)}})();(function(){jQuery.fn.jplist.PaginationService=function(a,c,b){b=Number(b);isNaN(b)&&(b=0);b=this.itemsNumber=b;null===c?c=b:(c=Number(c),isNaN(c)&&(c=b));this.itemsOnPage=c;c=(c=this.itemsOnPage)?Math.ceil(this.itemsNumber/c):0;c=this.pagesNumber=c;a=Number(a);isNaN(a)&&(a=0);a>c-1&&(a=0);this.currentPage=a;this.start=this.currentPage*this.itemsOnPage;a=this.itemsNumber;c=this.start+this.itemsOnPage;c>a&&(c=a);this.end=c;a=this.currentPage;this.prevPage=0>=a?0:a-1;a=this.currentPage;c=this.pagesNumber;
this.nextPage=0===c?0:a>=c-1?c-1:a+1}})();(function(){jQuery.fn.jplist.PaginationGoogleService=function(a,c,b){b=Number(b);isNaN(b)&&(b=0);b=this.itemsNumber=b;null===c?c=b:(c=Number(c),isNaN(c)&&(c=b));this.itemsOnPage=c;c=(c=this.itemsOnPage)?Math.ceil(this.itemsNumber/c):0;c=this.pagesNumber=c;a=Number(a);isNaN(a)&&(a=0);a>c-1&&(a=0);this.currentPage=a;this.start=this.currentPage*this.itemsOnPage;a=this.itemsNumber;c=this.start+this.itemsOnPage;c>a&&(c=a);this.end=c;a=this.currentPage;this.prevPage=0>=a?0:a-1;a=this.currentPage;c=this.pagesNumber;
this.nextPage=0===c?0:a>=c-1?c-1:a+1}})();(function(){jQuery.fn.jplist.FiltersService.dateFilter=function(a,c,b,d,e,f){for(var g,h,k=[],l=0;l<e.length;l++)if(g=e[l],h=g.findPathitem(d))jQuery.isNumeric(a)&&jQuery.isNumeric(c)&&jQuery.isNumeric(b)?(h=jQuery.fn.jplist.HelperService.formatDateTime(h.text,f))&&jQuery.isFunction(h.getFullYear)&&(h.setHours(0),h.setMinutes(0),h.setSeconds(0),h.getFullYear()===a&&h.getMonth()===c&&h.getDate()===b&&k.push(g)):k.push(g);return k}})();(function(){jQuery.fn.jplist.FiltersService.dateRangeFilter=function(a,c,b,d,e,f,g,h,k){for(var l=[],m,p,q,n,r=0;r<c.length;r++)if(m=c[r],p=m.findPathitem(a))q=!jQuery.isNumeric(d)||!jQuery.isNumeric(e)||!jQuery.isNumeric(f),n=!jQuery.isNumeric(g)||!jQuery.isNumeric(h)||!jQuery.isNumeric(k),q||n?l.push(m):(n=jQuery.fn.jplist.HelperService.formatDateTime(p.text,b))&&jQuery.isFunction(n.getFullYear)&&(p=new Date(d,e,f),q=new Date(g,h,k),n.setHours(0),n.setMinutes(0),n.setSeconds(0),n>=p&&n<=q&&l.push(m));
return l}})();(function(){jQuery.fn.jplist.FiltersService.pagerFilter=function(a,c){return c.slice(a.start,a.end)}})();(function(){jQuery.fn.jplist.FiltersService.pathFilter=function(a,c){for(var b,d,e=[],f=0;f<c.length;f++)b=c[f],"default"===a.jqPath?e.push(b):(d=b.findPathitem(a))&&e.push(b);return e}})();(function(){jQuery.fn.jplist.FiltersService.pathGroupFilter=function(a,c){var b,d=[],e,f=[];if(0>=a.length)return c;for(e=0;e<a.length;e++)b=a[e],b=new jQuery.fn.jplist.DataItemMemberPathModel(b,null),d.push(b);for(var g=0;g<c.length;g++){e=c[g];for(var h=0;h<d.length;h++)if(b=d[h],"default"===b.jqPath){f.push(e);break}else(b=e.findPathitem(b))&&f.push(e)}return f}})();(function(){jQuery.fn.jplist.FiltersService.rangeFilter=function(a,c,b,d,e,f){b=[];for(var g,h=jQuery.isNumeric(e),k=jQuery.isNumeric(f),l=0;l<c.length;l++)if(d=c[l],g=d.findPathitem(a))g=Number(g.text.replace(/[^-0-9\.]+/g,"")),isNaN(g)||(h&&k?g>=e&&g<=f&&b.push(d):h&&!k?g>=e&&b.push(d):!h&&k&&g<=f&&b.push(d));return b}})();(function(){var a=function(b){var a=[],c;if(b)for(var g=0;g<b.length;g++)(c=jQuery.trim(b[g]))&&a.push(c);return a},c=function(b,c){var f=!1,g;g=c.split(" or ");g=a(g);if(0<g.length)for(var f=-1!==b.indexOf(g[0]),h=1;h<g.length;h++)f=f||-1!==b.indexOf(g[h]);return f},b=function(b,e){var f,g,h=!1;f=e.split(" and ");f=a(f);if(0<f.length){g=f[0];for(var h=-1===g.indexOf(" or ")?-1!==b.indexOf(g):c(b,g),k=1;k<f.length;k++)g=f[k],h=-1===g.indexOf(" or ")?h&&-1!==b.indexOf(g):h&&c(b,g)}return h};jQuery.fn.jplist.FiltersService.advancedSearchParse=
function(d,e){e=jQuery.trim(e);if(-1===e.indexOf(" or ")&&-1===e.indexOf(" and ")&&-1===e.indexOf("not "))return-1!==d.indexOf(e);var f,g,h=!1;f=e.split("not ");f=a(f);if(0<f.length){g=f[0];for(var h=-1===g.indexOf(" and ")?-1===g.indexOf(" or ")?-1===d.indexOf(g):c(d,g):b(d,g),k=1;k<f.length;k++)g=f[k],h=-1===g.indexOf(" and ")?(h=-1===g.indexOf(" or ")?h&&-1===d.indexOf(g):h&&c(d,g))&&c(d,g):h&&b(d,g)}return h}})();(function(){jQuery.fn.jplist.FiltersService.textGroupFilter=function(a,c,b,d,e,f){var g,h,k;f=[];var l,m;if(0>=a.length)return e;k=new jQuery.fn.jplist.DataItemMemberPathModel(b,null);for(var p=0;p<e.length;p++)if(b=e[p],h=b.findPathitem(k),"default"===k.jqPath)f.push(b);else if(h)if(h=jQuery.fn.jplist.HelperService.removeCharacters(h.text,d),"or"===c)for(m=0;m<a.length;m++){if(g=a[m],g=jQuery.fn.jplist.HelperService.removeCharacters(g,d),jQuery.fn.jplist.FiltersService.advancedSearchParse(h,g)){f.push(b);
break}}else{l=[];for(m=0;m<a.length;m++)g=a[m],g=jQuery.fn.jplist.HelperService.removeCharacters(g,d),jQuery.fn.jplist.FiltersService.advancedSearchParse(h,g)&&l.push(g);l.length===a.length&&f.push(b)}return f}})();(function(){jQuery.fn.jplist.FiltersService.textFilter=function(a,c,b,d,e){var f,g,h=[],k;e=e||"contains";for(var l=0;l<b.length;l++)if(f=b[l],g=f.findPathitem(c),"default"===c.jqPath)h.push(f);else if(g)switch(g=jQuery.trim(jQuery.fn.jplist.HelperService.removeCharacters(g.text,d)),k=jQuery.trim(jQuery.fn.jplist.HelperService.removeCharacters(a,d)),e){case "startsWith":g.startsWith(k)&&h.push(f);break;case "endsWith":g.endsWith(k)&&h.push(f);break;case "advanced":jQuery.fn.jplist.FiltersService.advancedSearchParse(g,
k)&&h.push(f);break;case "equal":g===k&&h.push(f);break;default:-1!==g.indexOf(k)&&h.push(f)}return h}})();(function(){jQuery.fn.jplist.FiltersService.textFilterPathGroup=function(a,c,b,d){var e,f;d=[];var g=[],h,k,l;for(l=0;l<a.length;l++)k=a[l],k.selected&&(e=k.path,f=new jQuery.fn.jplist.DataItemMemberPathModel(e,null),k.pathObj=f,d.push(k));if(0>=d.length)return b;for(e=0;e<b.length;e++){a=b[e];l=!1;for(var m=0;m<d.length;m++)if(k=d[m],f=k.pathObj)if("default"===f.jqPath){l=!0;break}else if(f=a.findPathitem(f))switch(f=jQuery.trim(jQuery.fn.jplist.HelperService.removeCharacters(f.text,c)),h=jQuery.trim(jQuery.fn.jplist.HelperService.removeCharacters(k.text,
...
function(a,c){return null};jQuery.fn.jplist.ControlFactory.prototype.getPaths=function(a){return[]};jQuery.fn.jplist.ControlFactory.prototype.setByDeepLink=function(a){}})();(function(){var a=function(a,c){var e,f;e=new jQuery.fn.jplist.Statuses([]);for(var g=0;g<a.controls.length;g++)f=a.controls[g],jQuery.isFunction(f.getStatus)&&(f=f.getStatus(c))&&e.add(f,!1);return e.toArray()},c=function(a,c,e,f,g,h){c.each(function(){var c=jQuery(this);(c=(new jQuery.fn.jplist.ControlFactory(g,h,e,f)).create(c,a))&&a.controls.push(c)})};jQuery.fn.jplist.ControlsCollection=function(){this.controls=[]};jQuery.fn.jplist.ControlsCollection.prototype.merge=function(b,c){var e,f;f=new jQuery.fn.jplist.Statuses([]);
e=a(this,b);for(var g=0;g<e.length;g++)f.add(e[g],!1);if(c)for(e=0;e<c.length;e++)f.add(c[e],!0);return f.toArray()};jQuery.fn.jplist.ControlsCollection.prototype.statusesChangedByDeepLinks=function(a){for(var c,e=0;e<this.controls.length;e++)c=this.controls[e],jQuery.isFunction(c.setByDeepLink)&&c.setByDeepLink(a)};jQuery.fn.jplist.ControlsCollection.prototype.setDeepLinks=function(a,c){var e,f,g,h=new jQuery.fn.jplist.Statuses([]),k;for(k=0;k<a.length;k++){e=a[k];f=e.controlName;var l=[];g=void 0;
for(var m=0;m<this.controls.length;m++)g=this.controls[m],g.name===f&&l.push(g);f=l;for(l=0;l<f.length;l++)g=f[l],jQuery.isFunction(g.getStatusByDeepLink)&&(g=g.getStatusByDeepLink(e.propName,e.propValue))&&h.add(g,!1)}c.trigger(c.events.knownStatusesChanged,[h.toArray()]);c.trigger(c.events.statusesChangedByDeepLinks,[,h.toArray(),a])};jQuery.fn.jplist.ControlsCollection.prototype.setStatuses=function(a,c){for(var e,f,g=0;g<a.length;g++){e=a[g];f=e.name;for(var h=e.action,k=[],l=void 0,m=0;m<this.controls.length;m++)l=
this.controls[m],l.name===f&&l.action===h&&k.push(l);f=k;for(h=0;h<f.length;h++)jQuery.isFunction(f[h].setStatus)&&f[h].setStatus(e,c)}};jQuery.fn.jplist.ControlsCollection.prototype.getDeepLinksUrl=function(a){var c;c="";var e=[],f="",g;g=this.controls;for(var h=0;h<g.length;h++)c=g[h],jQuery.isFunction(c.getDeepLink)&&(f=jQuery.trim(c.getDeepLink())),""!==f&&-1===jQuery.inArray(f,e)&&e.push(f);return c=e.join(a)};jQuery.fn.jplist.ControlsCollection.prototype.getStatuses=function(b){return a(this,
b)};jQuery.fn.jplist.ControlsCollection.prototype.getPaths=function(){var a,c=[],e;e=new jQuery.fn.jplist.DataItemMemberPathCollection;for(var f=0;f<this.controls.length;f++)a=this.controls[f],jQuery.isFunction(a.getPaths)&&(a.getPaths(c),e.addRange(c));return e.paths};jQuery.fn.jplist.ControlsCollection.prototype.add=function(a,c,e,f,g){(a=(new jQuery.fn.jplist.ControlFactory(f,g,c,e)).create(a,this))&&this.controls.push(a)};jQuery.fn.jplist.ControlsCollection.prototype.addList=function(a,d,e,f,
g){c(this,a,d,e,f,g)}})();(function(){var a=function(a){var b=[];a=jQuery();jQuery(document).find("[data-control-type]").each(function(){var a=jQuery(this),c=a.attr("data-control-type");c&&jQuery.fn.jplist.controlTypes[c]&&jQuery.fn.jplist.controlTypes[c].dropdown&&b.push(a)});for(var c=0;c<b.length;c++)a=a.add(b[c]);return a},c=function(b){var c=a(b);0<c.length&&(jQuery(document).click(function(){c.find("ul").hide()}),jQuery(document).off(b.DROPDOWN_CLOSE_EVENT).on(b.DROPDOWN_CLOSE_EVENT,function(a,b){c.each(function(){jQuery(this).is(b)||
