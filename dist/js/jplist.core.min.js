/**
* jPList - jQuery Data Grid Controls 5.2.0.273 - http://jplist.com 
...
c.panel.paths);a(c);c.options.deepLinking?c.panel.setStatusesByDeepLink():c.panel.setStatusesFromStorage();return jQuery.extend(this,c)};jQuery.fn.jplist=function(a){if(a.command&&"init"!==a.command){var b;if(b=this.data("jplist"))return c(b,a.command,a.commandData)}else return this.each(function(){var c,b=jQuery(this);c=new e(a,b);b.data("jplist",c)})};jQuery.jplist={};jQuery.fn.jplist.controls=jQuery.fn.jplist.controls||{};jQuery.fn.jplist.itemControls=jQuery.fn.jplist.itemControls||{};jQuery.fn.jplist.controlTypes=
...
function(b){for(var c=null,a,e=0;e<this.pathitems.length;e++)if(a=this.pathitems[e],a.path.isEqual(b,!0)){c=a;break}return c};jQuery.fn.jplist.DataItemModel.prototype.addPaths=function(b){this.pathitems=this.pathitems.concat(d(this,b))}})();(function(){var d=function(a,c){var b,e,d;b=jQuery.fn.jplist.StatusesService.getFilterStatuses(c);if(0<b.length){for(var h=0;h<b.length;h++)e=b[h],d=jQuery.fn.jplist.DTOMapperService.filters[e.data.filterType],a.dataview=d(e,a.dataview);a.observer.trigger(a.observer.events.listFiltered,[c,a])}},b=function(a,c){var b,e=null,d=0,h=0;b=jQuery.fn.jplist.StatusesService.getStatusesByAction("paging",c);if(0<b.length){for(var g=0;g<b.length;g++)if(e=b[g],e.data&&(jQuery.isNumeric(e.data.currentPage)&&(d=
e.data.currentPage),jQuery.isNumeric(e.data.number)||"all"===e.data.number))h=e.data.number;e=new jQuery.fn.jplist.PaginationService(d,h,a.dataview.length);for(d=0;d<b.length;d++)b[d].data&&(b[d].data.paging=e);a.dataview=jQuery.fn.jplist.FiltersService.pagerFilter(e,a.dataview);a.observer.trigger(a.observer.events.listPaginated,[c,a])}},c=function(a,c){var b=[],b=jQuery.fn.jplist.StatusesService.getSortStatuses(c);0<b.length&&(jQuery.fn.jplist.SortService.doubleSort(b,a.dataview),a.observer.trigger(a.observer.events.listSorted,
[c,a]))},a=function(a){return jQuery(a.dataview).map(function(a,c){return c.jqElement.get()})},e=function(a){return jQuery(a.dataitems).map(function(a,c){return c.jqElement.get()})},h=function(a){a.dataview=jQuery.merge([],a.dataitems)},g=function(a,c){for(var b,e=-1,d,h=0;h<a.dataitems.length;h++)if(b=a.dataitems[h],b=jQuery.fn.jplist.HelperService.getOuterHtml(b.jqElement),d=jQuery.fn.jplist.HelperService.getOuterHtml(c),b===d){e=h;break}return e},f=function(a,c){var b;b=g(a,c);-1!==b&&(a.dataitems.splice(b,
1),a.observer.trigger(a.observer.events.dataItemRemoved,[c,a.dataitems]))},k=function(a,c){c.each(function(){f(a,jQuery(this))})},l=function(a,c,b,e){c=new jQuery.fn.jplist.DataItemModel(c,b,e);a.dataitems.splice(e,0,c);a.observer.trigger(a.observer.events.dataItemAdded,[c,a.dataitems])},m=function(a,c,b,e,d){for(var h;b<c.length;b++)h=c.eq(b),3!==h.get(0).nodeType&&(l(a,h,e,b),b+1<c.length&&0===b%50&&window.setTimeout(function(){m(a,c,b,e,d)},0))};jQuery.fn.jplist.Dataitems=function(a,c,b){this.dataitems=
...
function(d,b){if(d.deepLinking){var c=jQuery.trim(b.replace(d.hashStart,"")),a,c=""===c?d.hashStart:d.hashStart+c;window.location.hash!==c&&(a=window.location.href.indexOf(d.hashStart),c=-1==a?window.location.href+c:window.location.href.substring(0,a)+c,"replaceState"in window.history?window.history.replaceState("","",c):window.location.replace(c))}}})();(function(){var d=function(b,c,a,d){var h=c.dataitemsToJqueryObject(),g=c.dataviewToJqueryObject(),f=!1,k=jQuery.extend(!0,{},b.options,{duration:0});0>=h.length||0>=g.length?(b.$noResults.removeClass("jplist-hidden"),b.$itemsBox.addClass("jplist-hidden"),jQuery.isFunction(b.redrawCallback)&&b.redrawCallback(c,g,a)):(b.$noResults.addClass("jplist-hidden"),b.$itemsBox.removeClass("jplist-hidden"),b.effect&&jQuery.fn.jplist.animation?(d&&!d.inAnimation&&(f=!0),d=f?k:b.options,jQuery.fn.jplist.animation.drawItems(d,
b.$itemsBox,h,g,b.effect,function(){jQuery.isFunction(b.redrawCallback)&&b.redrawCallback(c,g,a)},b.observer)):(h.detach(),b.$itemsBox.append(g),jQuery.isFunction(b.redrawCallback)&&b.redrawCallback(c,g,a)));return g};jQuery.fn.jplist.DOMView=function(b,c,a,d,h,g,f){this.options=c;this.$root=b;this.observer=a;this.redrawCallback=g;this.effect=f;this.$itemsBox=b.find(d).eq(0);this.$noResults=b.find(h)};jQuery.fn.jplist.DOMView.prototype.render=function(b,c,a){return d(this,b,c,a)}})();(function(){jQuery.fn.jplist.DOMController=function(d,b,c,a){this.observer=c;this.$root=d;this.listView=new jQuery.fn.jplist.DOMView(d,b,c,b.itemsBox,b.noResults,b.redrawCallback,b.effect);d=b.itemPath;b=this.$root.find(b.itemsBox).eq(0).find(d);this.collection=new jQuery.fn.jplist.Dataitems(this.observer,b,a)};jQuery.fn.jplist.DOMController.prototype.renderStatuses=function(d,b){var c;this.collection&&(this.collection.applyStatuses(d),c=this.listView.render(this.collection,d,b));return c};jQuery.fn.jplist.DOMController.prototype.addPaths=
