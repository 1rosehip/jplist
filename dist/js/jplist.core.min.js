/**
* jPList - jQuery Data Grid Controls 5.2.0.33 - http://jplist.com 
...
"nov"===c||"nov."===c)a=10;if("december"===c||"dec"===c||"dec."===c)a=11;null===a&&(a=parseInt(c,10),isNaN(a)||a--)}else a=parseInt(c,10);return a},d=function(b,a){var d,e=null;d=b.replace(/{year}|{month}|{day}|{hour}|{min}|{sec}/g,".*");(d=(new RegExp(d,"g")).exec(a))&&1<d.length&&(e=d[1]);return e};jQuery.fn.jplist.domain.dom.services.HelperService={};jQuery.fn.jplist.domain.dom.services.HelperService.getOuterHtml=function(b){var a="",d,e;if(b&&b[0]&&b[0].tagName){d=b[0].attributes;e=b.html();b=
...
[d]))}else c(a,!0);else c(a,!0)},c=function(a,b){var c;c=a.controls.getStatuses(b);0<c.length&&a.observer.trigger(a.observer.events.knownStatusesChanged,[c])},f=function(a){var b;b=[];b=a.$root.find(a.options.panelPath).find("[data-control-type]");a.controls=new jQuery.fn.jplist.ui.panel.collections.ControlsCollection(a.options,a.observer,a.history,a.$root,b);a.paths=a.controls.getPaths();jQuery.fn.jplist.logEnabled(a.options)&&(b=jQuery.map(a.paths,function(a,b){return a&&a.jqPath?a.jqPath:""}),
jQuery.fn.jplist.info(a.options,"Panel paths: ",b.join(", ")))};jQuery.fn.jplist.ui.panel.controllers.PanelController=function(a,b,c,k){this.options=b;this.$root=a;this.history=c;this.observer=k;this.controls=this.paths=this.$sticky=null;f(this);this.$sticky=a.find('[data-sticky="true"]');0<this.$sticky.length&&d(this,this.$sticky)};jQuery.fn.jplist.ui.panel.controllers.PanelController.prototype.setStatusesByDeepLink=function(){var a;a=jQuery.fn.jplist.dal.services.DeepLinksService.getUrlParams(this.options);
...
this.$root=e;this.controlFactory=null;this.$controls=g;this.controls=[];this.controlFactory=new jQuery.fn.jplist.ui.panel.ControlFactory(a,c,f,e);for(c=0;c<this.$controls.length;c++)a=this.$controls.eq(c),d(this,a)};jQuery.fn.jplist.ui.panel.collections.ControlsCollection.prototype.merge=function(b,c){var d,e;e=new jQuery.fn.jplist.app.dto.StatusesDTOCollection(this.options,this.observer,[]);d=a(this,b);for(var g=0;g<d.length;g++)e.add(d[g],!1);if(c)for(d=0;d<c.length;d++)e.add(c[d],!0);return e.toArray()};
jQuery.fn.jplist.ui.panel.collections.ControlsCollection.prototype.statusesChangedByDeepLinks=function(a){for(var c,d=0;d<this.controls.length;d++)c=this.controls[d],jQuery.isFunction(c.setByDeepLink)&&c.setByDeepLink(a)};jQuery.fn.jplist.ui.panel.collections.ControlsCollection.prototype.setDeepLinks=function(a){var c,d,e,g=new jQuery.fn.jplist.app.dto.StatusesDTOCollection(this.options,this.observer,[]),h;for(h=0;h<a.length;h++){c=a[h];d=c.controlName;var k=[];e=void 0;for(var l=0;l<this.controls.length;l++)e=
this.controls[l],e.name===d&&k.push(e);d=k;for(k=0;k<d.length;k++)e=d[k],jQuery.isFunction(e.getStatusByDeepLink)&&(e=e.getStatusByDeepLink(c.propName,c.propValue))&&g.add(e,!1)}this.observer.trigger(this.observer.events.knownStatusesChanged,[g.toArray()]);this.observer.trigger(this.observer.events.statusesChangedByDeepLinks,[,g.toArray(),a])};jQuery.fn.jplist.ui.panel.collections.ControlsCollection.prototype.setStatuses=function(a,c){for(var d,e,g=0;g<a.length;g++){d=a[g];e=d.name;for(var h=d.action,
k=[],l=void 0,m=0;m<this.controls.length;m++)l=this.controls[m],l.name===e&&l.action===h&&k.push(l);e=k;for(h=0;h<e.length;h++)jQuery.isFunction(e[h].setStatus)&&e[h].setStatus(d,c)}};jQuery.fn.jplist.ui.panel.collections.ControlsCollection.prototype.getDeepLinksUrl=function(){var a;a="";var c=[],d="",e;e=this.controls;for(var g=0;g<e.length;g++)a=e[g],jQuery.isFunction(a.getDeepLink)&&(d=jQuery.trim(a.getDeepLink())),""!==d&&-1===jQuery.inArray(d,c)&&c.push(d);return a=c.join(this.options.delimiter1)};
jQuery.fn.jplist.ui.panel.collections.ControlsCollection.prototype.getStatuses=function(b){return a(this,b)};jQuery.fn.jplist.ui.panel.collections.ControlsCollection.prototype.getPaths=function(){var a,c=[],d;d=new jQuery.fn.jplist.domain.dom.collections.DataItemMemberPathCollection(this.options,this.observer);for(var e=0;e<this.controls.length;e++)a=this.controls[e],jQuery.isFunction(a.getPaths)&&(a.getPaths(c),d.addRange(c));return d.paths};jQuery.fn.jplist.ui.panel.collections.ControlsCollection.prototype.add=
function(a){d(this,a)}})();(function(){var a=function(a){var b=[];a=jQuery();jQuery(document).find("[data-control-type]").each(function(){var a=jQuery(this),c=a.attr("data-control-type");c&&jQuery.fn.jplist.controlTypes[c]&&jQuery.fn.jplist.controlTypes[c].dropdown&&b.push(a)});for(var d=0;d<b.length;d++)a=a.add(b[d]);return a},d=function(b){var d=a(b);0<d.length&&(jQuery(document).click(function(){d.find("ul").hide()}),jQuery(document).off(b.DROPDOWN_CLOSE_EVENT).on(b.DROPDOWN_CLOSE_EVENT,function(a,b){d.each(function(){jQuery(this).is(b)||
