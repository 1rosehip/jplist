/**
* jPList - jQuery Data Grid Controls 5.2.0.254 - http://jplist.com 
...
[!1]))},c=function(a,c,e){switch(c){case "add":d(a,e);break;case "del":b(a,e);break;case "getDataItems":c=null;if(a.options&&a.options.dataSource)switch(a.options.dataSource.type){case "html":a.controller&&a.controller.collection&&(c=a.controller.collection.dataitems);break;case "server":a.controller&&a.controller.model&&a.controller.model.dataItem&&(c=a.controller.model.dataItem)}return c;case "addControl":a&&a.panel&&a.controller&&(a.panel.addControl(e.$control),a.controller.addPaths(a.panel.paths))}},
a=function(a){a.observer.on(a.observer.events.knownStatusesChanged,function(b,c){var e;if(c&&(a.history.addStatuses(c),(e=a.panel.mergeStatuses(c))&&0<e.length&&(a.storage.save(e),a.controller.renderStatuses(e,a.history.getLastStatus()),e=!1,c))){for(var d=0;d<c.length;d++)if(c[d].isAnimateToTop){e=!0;break}e&&(e=jQuery(a.options.animateToTop).offset().top,jQuery("html, body").animate({scrollTop:e},a.options.animateToTopDuration))}});a.observer.on(a.observer.events.unknownStatusesChanged,function(b,
c){var e;e=a.panel.getStatuses(c);0<e.length&&(a.storage.save(e),a.controller.renderStatuses(e,a.history.getLastStatus()))});a.observer.on(a.observer.events.statusesAppliedToList,function(b,c,e){a.panel.setStatuses(e);jQuery.fn.jplist.DeepLinksService.updateUrlPerControls(a.options,a.panel.getDeepLinksURLPerControls())});a.observer.on(a.observer.events.statusesChangedByDeepLinks,function(b,c,e){a.panel.statusesChangedByDeepLinks(c,e)});a.$root.find(a.options.iosBtnPath).on("click",function(){jQuery(this).next(a.options.panelPath).toggleClass("jplist-ios-show")})},
e=function(b,c){var e={observer:null,panel:null,controller:null,storage:null,$root:c};e.options=jQuery.extend(!0,{debug:!1,command:"init",commandData:{},itemsBox:".list",itemPath:".list-item",panelPath:".panel",noResults:".jplist-no-results",redrawCallback:"",iosBtnPath:".jplist-ios-button",animateToTop:"html, body",animateToTopDuration:0,effect:"",duration:300,fps:24,storage:"",storageName:"jplist",cookiesExpiration:-1,deepLinking:!1,hashStart:"#",delimiter0:":",delimiter1:"|",delimiter2:"~",delimiter3:"!",
historyLength:10},b);e.observer=new jQuery.fn.jplist.PubSub(e.$root,e.options);e.history=new jQuery.fn.jplist.History(e.$root,e.options,e.observer);e.panel=new jQuery.fn.jplist.PanelController(c,e.options,e.history,e.observer);e.storage=new jQuery.fn.jplist.Storage(e.options.storage,e.options.storageName,e.options.cookiesExpiration);e.itemControls=new jQuery.fn.jplist.ItemControlCollection(e.options,e.observer,e.history,e.$root);e.controller=new jQuery.fn.jplist.DOMController(e.$root,e.options,e.observer,
e.panel.paths);a(e);e.options.deepLinking?e.panel.setStatusesByDeepLink():e.panel.setStatusesFromStorage();return jQuery.extend(this,e)};jQuery.fn.jplist=function(a){if(a.command&&"init"!==a.command){var b;if(b=this.data("jplist"))return c(b,a.command,a.commandData)}else return this.each(function(){var b,c=jQuery(this);b=new e(a,c);c.data("jplist",b)})};jQuery.jplist={};jQuery.fn.jplist.controls=jQuery.fn.jplist.controls||{};jQuery.fn.jplist.itemControls=jQuery.fn.jplist.itemControls||{};jQuery.fn.jplist.controlTypes=
...
function(d,b){if(d.deepLinking){var c=jQuery.trim(b.replace(d.hashStart,"")),a,c=""===c?d.hashStart:d.hashStart+c;window.location.hash!==c&&(a=window.location.href.indexOf(d.hashStart),c=-1==a?window.location.href+c:window.location.href.substring(0,a)+c,"replaceState"in window.history?window.history.replaceState("","",c):window.location.replace(c))}}})();(function(){jQuery.fn.jplist.animation={};jQuery.fn.jplist.animation.drawItems=function(d,b,c,a,e,h,g,f){var k,l,m;if(e=jQuery.fn.jplist.animation[e]){k=e.before;m=e.effect;l=e.after;jQuery.isFunction(k)&&k(d,b,c,a);if(jQuery.isFunction(m))f.on(f.events.animationStepEvent,function(e,g,h){m(d,b,c,a,g)});f.on(f.events.animationCompleteEvent,function(e){jQuery.isFunction(l)&&l(d,b,c,a);f.off(f.events.animationStepEvent);f.off(f.events.animationCompleteEvent);jQuery.isFunction(g)&&g()});h.play(d.duration)}else jQuery.isFunction(g)&&
g()}})();(function(){var d=function(b){b.handler&&window.clearTimeout(b.handler);b.progress=0;b.start=null;b.observer.trigger(b.observer.events.animationCompleteEvent,[])},b=function(c,a){jQuery.isNumeric(a)&&0<a?c.handler=window.setTimeout(function(){var e;null===c.start&&(c.observer.trigger(c.observer.events.animationStartEvent,[]),c.start=(new Date).getTime());e=(new Date).getTime()-c.start;c.progress=e/a;1<=c.progress&&(c.progress=1);c.observer.trigger(c.observer.events.animationStepEvent,[100*c.progress,
c]);1>c.progress?b(c,a):d(c)},c.delay):d(c)};jQuery.fn.jplist.animation.Timeline=function(b,a){this.observer=a;this.start=null;this.progress=0;this.handler=this.delay=null;this.delay=1E3/b};jQuery.fn.jplist.animation.Timeline.prototype.play=function(c){b(this,c)};jQuery.fn.jplist.animation.Timeline.prototype.stop=function(){d(this)}})();(function(){jQuery.fn.jplist.animation.fade={};jQuery.fn.jplist.animation.fade.before=function(d,b,c,a){};jQuery.fn.jplist.animation.fade.effect=function(d,b,c,a,e){b.find(d.itemPath).css({opacity:(100-e)/100})};jQuery.fn.jplist.animation.fade.after=function(d,b,c,a){b.empty();a.css({opacity:1});b.append(a)}})();(function(){var d=function(b,c,a,e){var d=c.dataitemsToJqueryObject(),g=c.dataviewToJqueryObject(),f=!1,k=jQuery.extend(!0,{},b.options,{duration:0});0>=d.length||0>=g.length?(b.$noResults.removeClass("jplist-hidden"),b.$itemsBox.addClass("jplist-hidden"),jQuery.isFunction(b.redrawCallback)&&b.redrawCallback(c,g,a)):(b.$noResults.addClass("jplist-hidden"),b.$itemsBox.removeClass("jplist-hidden"),b.effect?(e&&!e.inAnimation&&(f=!0),e=f?k:b.options,jQuery.fn.jplist.animation.drawItems(e,b.$itemsBox,
d,g,b.effect,b.timeline,function(){jQuery.isFunction(b.redrawCallback)&&b.redrawCallback(c,g,a)},b.observer)):(d.detach(),b.$itemsBox.append(g),jQuery.isFunction(b.redrawCallback)&&b.redrawCallback(c,g,a)));return g};jQuery.fn.jplist.DOMView=function(b,c,a,e,d,g,f,k){this.options=c;this.$root=b;this.observer=a;this.redrawCallback=g;this.effect=f;this.timelineZero=this.timeline=null;this.$itemsBox=b.find(e).eq(0);this.$noResults=b.find(d);f&&(this.timeline=new jQuery.fn.jplist.animation.Timeline(k,
this.observer))};jQuery.fn.jplist.DOMView.prototype.render=function(b,c,a){return d(this,b,c,a)}})();(function(){jQuery.fn.jplist.DOMController=function(d,b,c,a){this.observer=c;this.$root=d;this.listView=new jQuery.fn.jplist.DOMView(d,b,c,b.itemsBox,b.noResults,b.redrawCallback,b.effect,b.fps);d=b.itemPath;b=this.$root.find(b.itemsBox).eq(0).find(d);this.collection=new jQuery.fn.jplist.Dataitems(this.observer,b,a)};jQuery.fn.jplist.DOMController.prototype.renderStatuses=function(d,b){var c;this.collection&&(this.collection.applyStatuses(d),c=this.listView.render(this.collection,d,b));return c};
...
a.length;k++){c=a[k];d=!1;for(var l=0;l<f.length;l++)f[l].name===c.name&&f[l].action===c.action&&(d=!0,f[l].statuses.push(c));d||f.push({name:c.name,action:c.action,statuses:[c]})}for(l=0;l<f.length;l++)if(c=f[l],c.statuses&&0<c.statuses.length){d=c.statuses[0].name;for(var k=c.statuses[0].action,m=[],n=void 0,q=0;q<this.controls.length;q++)n=this.controls[q],n.name===d&&n.action===k&&m.push(n);d=m;for(k=0;k<d.length;k++)jQuery.isFunction(d[k].setStatus)&&(1<c.statuses.length?d[k].setStatus(c.statuses,
