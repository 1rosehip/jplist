...
a.params.panelAllText:(c=jQuery.trim(b.next("label").text()),c=a.params.panelSelectedText.replace(/{selected}/g,c)));return c},l=function(a){a.params.$radioButtons.off("change").on("change",function(b){a.history.addStatus(d(a,!1));a.observer.trigger(a.observer.events.knownStatusesChanged,[[d(a,!1)]])});a.$control.find("li").off("click").on("click",function(a){a.stopPropagation()})},e=function(a){a.params={$radioButtons:a.$control.find("[data-path]"),$panel:null,panelSelectedText:a.$control.attr("data-panel-selected-text")||
