...
(this.$root.addClass(a.data.view),this.params.currentView=a.data.view))};jQuery.fn.jplist.ui.controls.Views=function(a){return new e(a)};jQuery.fn.jplist.controlTypes.views={className:"Views",options:{}}})();(function(){jQuery.fn.jplist.ui.controls.ViewsDTO=function(d){this.view=d}})();
