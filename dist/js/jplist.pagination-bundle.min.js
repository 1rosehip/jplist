...
function(b,a){var e;a:if(e=null,this.inDeepLinking){if("currentPage"!==b){e=null;break a}e=f(this,!0);e.data&&"currentPage"===b&&(e.data.currentPage=a)}return e};d.prototype.setStatus=function(b,a){var e;if(jQuery.isArray(b))for(var c=0;c<b.length;c++)b[c].data&&b[c].data.paging&&(e=b[c].data.paging);else b.data&&(e=b.data.paging);e&&this.params.view.build(e)};jQuery.fn.jplist.controls.Pagination=function(b){return new d(b)};jQuery.fn.jplist.controlTypes.pagination={className:"Pagination",options:{}}})();(function(){var f=function(d,b,a){var e;e='<div class="jplist-pagesbox" data-type="pagesbox">';for(var c=d;c<b;c++)e+='<button type="button" data-type="page" ',c===a&&(e+=' class="jplist-current" data-active="true" '),d=c+1,e+=' data-number="'+c+'" ',e+=">"+d+"</button> ";return e+"</div>"},g=function(d,b){var a={$control:d,options:b,$pagingprev:null,$pagingmid:null,$pagingnext:null,$jplistFirst:null,$jplistPrev:null,$jplistNext:null,$jplistLast:null,mode:d.attr("data-mode")},e,c,f,h;e=a.$control.attr("data-prev")||
