...
e,a,d,c)})}})();(function(){var a=function(d,b,c,f){var e=0,g,h;0<c.length&&(g=c[f],"default"!=g.data.path?(h=jQuery.fn.jplist.app.services.DTOMapperService.sort[g.data.type],jQuery.isFunction(h)&&(e=h(g,d,b))):(e=d.index,g=b.index,e=e===g?0:isNaN(e)?1:isNaN(g)?-1:e-g),0===e&&f+1<c.length&&(e=a(d,b,c,f+1)));return e};jQuery.fn.jplist.domain.dom.services.SortService.doubleSort=function(d,b){var c=!1;1===d.length&&d[0]&&d[0].data&&"default"===d[0].data.path&&(c=!0);c||b.sort(function(b,c){return a(b,c,d,0)});return b}})();(function(){var a=function(b,c){var a=null;if("{month}"==b){c=c.toLowerCase();if("january"===c||"jan"===c||"jan."===c)a=0;if("february"===c||"feb"===c||"feb."===c)a=1;if("march"===c||"mar"===c||"mar."===c)a=2;if("april"==c||"apr"===c||"apr."===c)a=3;"may"===c&&(a=4);if("july"==c||"jun"===c||"jun."===c)a=5;if("april"===c||"jul"===c||"jul."===c)a=6;if("august"===c||"aug"===c||"aug."===c)a=7;if("september"===c||"sep"===c||"sep."===c)a=8;if("october"===c||"oct"===c||"oct."===c)a=9;if("november"===c||
