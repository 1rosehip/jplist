...
{debug:!1,command:"init",commandData:{},itemsBox:".list",itemPath:".list-item",panelPath:".panel",noResults:".jplist-no-results",redrawCallback:"",iosBtnPath:".jplist-ios-button",animateToTop:"html, body",animateToTopDuration:0,effect:"",duration:300,fps:24,storage:"",storageName:"jplist",cookiesExpiration:-1,deepLinking:!1,delimiter0:":",delimiter1:"|",delimiter2:"~",delimiter3:"!",historyLength:10,dataSource:{type:"html",server:{ajax:{url:"server.php",dataType:"html",type:"POST"},serverOkCallback:null,
serverErrorCallback:null},render:null}},b);e.observer=new jQuery.fn.jplist.app.events.PubSub(e.$root,e.options);e.history=new jQuery.fn.jplist.app.History(e.$root,e.options,e.observer);e.panel=new jQuery.fn.jplist.ui.panel.controllers.PanelController(a,e.options,e.history,e.observer);e.options.dataSource=e.options.dataSource||{};e.options.dataSource.type=e.options.dataSource.type||"html";jQuery.fn.jplist.info(e.options,"Data Source Type: ",e.options.dataSource.type);switch(e.options.dataSource.type){case "html":e.controller=
...
e);if(0<b.length){for(var k=0;k<b.length;k++)if((c=b[k])&&c.data&&c.data.sortGroup&&jQuery.isArray(c.data.sortGroup)&&0<c.data.sortGroup.length)for(var h=0;h<c.data.sortGroup.length;h++)f=new jQuery.fn.jplist.app.dto.StatusDTO(c.name,c.action,c.type,c.data.sortGroup[h],c.inStorage,c.inAnimation,c.isAnimateToTop,c.inDeepLinking),d.push(f);else d.push(c);jQuery.fn.jplist.domain.dom.services.SortService.doubleSort(d,a.dataview);a.observer.trigger(a.observer.events.listSorted,[e,a])}},a=function(a){return jQuery(a.dataview).map(function(a,
e){return e.jqElement.get()})},e=function(a){return jQuery(a.dataitems).map(function(a,e){return e.jqElement.get()})},k=function(a){a.dataview=jQuery.merge([],a.dataitems)},f=function(a,e){for(var b,c=-1,d,f=0;f<a.dataitems.length;f++)if(b=a.dataitems[f],b=jQuery.fn.jplist.domain.dom.services.HelperService.getOuterHtml(b.jqElement),d=jQuery.fn.jplist.domain.dom.services.HelperService.getOuterHtml(e),b===d){c=f;break}return c},g=function(a,e){var b;b=f(a,e);-1!==b&&(a.dataitems.splice(b,1),a.observer.trigger(a.observer.events.dataItemRemoved,
[e,a.dataitems]))},h=function(a,e){e.each(function(){g(a,jQuery(this))})},l=function(a,e,b,c){e=new jQuery.fn.jplist.domain.dom.models.DataItemModel(e,b,c);a.dataitems.splice(c,0,e);a.observer.trigger(a.observer.events.dataItemAdded,[e,a.dataitems])},m=function(a,e,b,c){for(var d;b<e.length;b++)d=e.eq(b),l(a,d,c,b),b+1<e.length&&0===b%50&&window.setTimeout(function(){m(a,e,b,c)},0)},n=function(a,e,b,c){a={dataitems:[],dataview:[],options:a,observer:e,paths:c};0<b.length&&(m(a,b,0,c),k(a));a.observer.trigger(a.observer.events.collectionReadyEvent,
[a]);return jQuery.extend(this,a)};n.prototype.applyStatuses=function(a){k(this);b(this,a);d(this,a);c(this,a);this.observer.trigger(this.observer.events.statusesAppliedToList,[this,a])};n.prototype.filter=function(a){d(this,a)};n.prototype.sort=function(a){b(this,a)};n.prototype.pagination=function(a){c(this,a)};n.prototype.dataviewToJqueryObject=function(){return a(this)};n.prototype.dataitemsToJqueryObject=function(){return e(this)};n.prototype.resetDataview=function(){k(this)};n.prototype.empty=
function(){this.dataitems=[];this.dataview=[]};n.prototype.addDataItem=function(a,e,b){l(this,a,e,b)};n.prototype.addDataItems=function(a,e){m(this,a,0,e);k(this)};n.prototype.delDataitem=function(a){g(this,a)};n.prototype.delDataitems=function(a){h(this,a)};n.prototype.indexOf=function(a){return f(this,a)};n.prototype.dataviewToString=function(){var a,e="",b;for(b=0;b<this.dataview.length;b++)a=this.dataview[b],e+=a.content;return e};jQuery.fn.jplist.domain.dom.collections.DataItemsCollection=function(a,
...
c=this.pagesNumber;this.nextPage=0===c?0:d>=c-1?c-1:d+1}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.autocompleteFilter=function(d,c,b,a,e){var k=[],f,g;if(jQuery.isNumeric(d)&&jQuery.isNumeric(c)&&google&&jQuery.fn.jlocator&&jQuery.fn.jlocator.store){d=new google.maps.LatLng(d,c);for(var h=0;h<a.length;h++)c=a[h],f=new jQuery.fn.jlocator.store(c.jqElement,{}),g=f.country?jQuery.trim(f.country.toLowerCase())==jQuery.trim(b.toLowerCase()):!1,f=google.maps.geometry.spherical.computeDistanceBetween(d,f.latlng),(f<=e||g)&&k.push(c);return k}return a}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.dateFilter=function(d,c,b,a,e,k){for(var f,g,h=[],l=0;l<e.length;l++)if(f=e[l],g=f.findPathitem(a))if(!jQuery.isNumeric(d)||!jQuery.isNumeric(c)||!jQuery.isNumeric(b))h.push(f);else if((g=jQuery.fn.jplist.domain.dom.services.HelperService.formatDateTime(g.text,k))&&jQuery.isFunction(g.getFullYear))g.setHours(0),g.setMinutes(0),g.setSeconds(0),g.getFullYear()===d&&(g.getMonth()===c&&g.getDate()===b)&&h.push(f);return h}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.dateRangeFilter=function(d,c,b,a,e,k,f,g,h){for(var l=[],m,n,q,p,r=0;r<c.length;r++)if(m=c[r],n=m.findPathitem(d))if(q=!jQuery.isNumeric(a)||!jQuery.isNumeric(e)||!jQuery.isNumeric(k),p=!jQuery.isNumeric(f)||!jQuery.isNumeric(g)||!jQuery.isNumeric(h),q||p)l.push(m);else if((p=jQuery.fn.jplist.domain.dom.services.HelperService.formatDateTime(n.text,b))&&jQuery.isFunction(p.getFullYear))n=new Date(a,e,k),q=new Date(f,g,h),p.setHours(0),
p.setMinutes(0),p.setSeconds(0),p>=n&&p<=q&&l.push(m);return l}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.pagerFilter=function(d,c){return c.slice(d.start,d.end)}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.pathFilter=function(d,c){for(var b,a,e=[],k=0;k<c.length;k++)b=c[k],"default"===d.jqPath?e.push(b):(a=b.findPathitem(d))&&e.push(b);return e}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.pathGroupFilter=function(d,c){var b,a=[],e,k=[];if(0>=d.length)return c;for(e=0;e<d.length;e++)b=d[e],b=new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(b,null),a.push(b);for(var f=0;f<c.length;f++){e=c[f];for(var g=0;g<a.length;g++)if(b=a[g],"default"===b.jqPath){k.push(e);break}else(b=e.findPathitem(b))&&k.push(e)}return k}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.rangeFilter=function(d,c,b,a,e,k){b=[];for(var f,g=jQuery.isNumeric(e),h=jQuery.isNumeric(k),l=0;l<c.length;l++)if(a=c[l],f=a.findPathitem(d))f=Number(f.text.replace(/[^-0-9\.]+/g,"")),isNaN(f)||(g&&h?f>=e&&f<=k&&b.push(a):g&&!h?f>=e&&b.push(a):!g&&h&&f<=k&&b.push(a));return b}})();(function(){var d=function(a){var e=[],b;if(a)for(var c=0;c<a.length;c++)(b=jQuery.trim(a[c]))&&e.push(b);return e},c=function(a,e){var b=!1,c;c=e.split(" or ");c=d(c);if(0<c.length)for(var b=-1!==a.indexOf(c[0]),g=1;g<c.length;g++)b=b||-1!==a.indexOf(c[g]);return b},b=function(a,e){var b,f,g=!1;b=e.split(" and ");b=d(b);if(0<b.length){f=b[0];for(var g=-1===f.indexOf(" or ")?-1!==a.indexOf(f):c(a,f),h=1;h<b.length;h++)f=b[h],g=-1===f.indexOf(" or ")?g&&-1!==a.indexOf(f):g&&c(a,f)}return g};jQuery.fn.jplist.domain.dom.services.FiltersService.advancedSearchParse=
function(a,e){e=jQuery.trim(e);if(-1===e.indexOf(" or ")&&-1===e.indexOf(" and ")&&-1===e.indexOf("not "))return-1!==a.indexOf(e);var k,f,g=!1;k=e.split("not ");k=d(k);if(0<k.length){f=k[0];for(var g=-1===f.indexOf(" and ")?-1===f.indexOf(" or ")?-1===a.indexOf(f):c(a,f):b(a,f),h=1;h<k.length;h++)f=k[h],g=-1===f.indexOf(" and ")?(g=-1===f.indexOf(" or ")?g&&-1===a.indexOf(f):g&&c(a,f))&&c(a,f):g&&b(a,f)}return g}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.textGroupFilter=function(d,c,b,a,e){var k,f,g,h=[],l,m;if(0>=d.length)return e;g=new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(b,null);for(var n=0;n<e.length;n++)if(b=e[n],f=b.findPathitem(g),"default"===g.jqPath)h.push(b);else if(f)if(f=jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters(f.text,a),"or"===c)for(m=0;m<d.length;m++){if(k=d[m],k=jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters(k,
a),jQuery.fn.jplist.domain.dom.services.FiltersService.advancedSearchParse(f,k)){h.push(b);break}}else{l=[];for(m=0;m<d.length;m++)k=d[m],k=jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters(k,a),jQuery.fn.jplist.domain.dom.services.FiltersService.advancedSearchParse(f,k)&&l.push(k);l.length===d.length&&h.push(b)}return h}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.textFilter=function(d,c,b,a){for(var e,k,f=[],g,h=0;h<b.length;h++)e=b[h],k=e.findPathitem(c),"default"===c.jqPath?f.push(e):k&&(k=jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters(k.text,a),g=jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters(d,a),jQuery.fn.jplist.domain.dom.services.FiltersService.advancedSearchParse(k,g)&&f.push(e));return f}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.textFilterPathGroup=function(d,c,b){var a,e,k=[],f=[],g,h;for(h=0;h<d.length;h++)g=d[h],g.selected&&(a=g.path,e=new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(a,null),g.pathObj=e,k.push(g));if(0>=k.length)return b;for(a=0;a<b.length;a++){d=b[a];h=!1;for(var l=0;l<k.length;l++)if(g=k[l],e=g.pathObj)if("default"===e.jqPath){h=!0;break}else if(e=d.findPathitem(e))e=jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters(e.text,
c),g=jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters(g.text,c),jQuery.fn.jplist.domain.dom.services.FiltersService.advancedSearchParse(e,g)&&(h=!0);h&&f.push(d)}return f}})();(function(){jQuery.fn.jplist.domain.dom.services.SortService.datetimeHelper=function(d,c,b,a,e){d=d.findPathitem(a);c=c.findPathitem(a);return d&&c?(jQuery.trim(e)?(a=jQuery.fn.jplist.domain.dom.services.HelperService.formatDateTime(d.text,e),e=jQuery.fn.jplist.domain.dom.services.HelperService.formatDateTime(c.text,e)):(a=new Date(Date.parse(d.text)),e=new Date(Date.parse(c.text))),a==e?0:"asc"==b?a>e?1:-1:a<e?1:-1):0};jQuery.fn.jplist.domain.dom.services.SortService.datetime=function(d,c,b,a){b.sort(function(e,
...
b,d,c,a)})}})();(function(){var d=function(c,b,a,e){var k=0,f,g;0<a.length&&(f=a[e],"default"!=f.data.path?(g=jQuery.fn.jplist.app.services.DTOMapperService.sort[f.data.type],jQuery.isFunction(g)&&(k=g(f,c,b))):(k=c.index,f=b.index,k=k===f?0:isNaN(k)?1:isNaN(f)?-1:k-f),0===k&&e+1<a.length&&(k=d(c,b,a,e+1)));return k};jQuery.fn.jplist.domain.dom.services.SortService.doubleSort=function(c,b){var a=!1;1===c.length&&(c[0]&&c[0].data&&"default"===c[0].data.path)&&(a=!0);a||b.sort(function(a,b){return d(a,b,c,0)});return b}})();(function(){var d=function(b,a){var e=null;if("{month}"==b){a=a.toLowerCase();if("january"===a||"jan"===a||"jan."===a)e=0;if("february"===a||"feb"===a||"feb."===a)e=1;if("march"===a||"mar"===a||"mar."===a)e=2;if("april"==a||"apr"===a||"apr."===a)e=3;"may"===a&&(e=4);if("july"==a||"jun"===a||"jun."===a)e=5;if("april"===a||"jul"===a||"jul."===a)e=6;if("august"===a||"aug"===a||"aug."===a)e=7;if("september"===a||"sep"===a||"sep."===a)e=8;if("october"===a||"oct"===a||"oct."===a)e=9;if("november"===a||
...
a.controls.getStatuses(e);a.observer.trigger(a.observer.events.knownStatusesChanged,[c]);b(a)},k=function(a){var b;b=[];b=a.$root.find(a.options.panelPath).find("[data-control-type]");a.controls=new jQuery.fn.jplist.ui.panel.collections.ControlsCollection(a.options,a.observer,a.history,a.$root,b);a.paths=a.controls.getPaths();jQuery.fn.jplist.logEnabled(a.options)&&(b=jQuery.map(a.paths,function(a,b){return a&&a.jqPath?a.jqPath:""}),jQuery.fn.jplist.info(a.options,"Panel paths: ",b.join(", ")))},
...
g=function(a,b,e,d){a={options:b,$root:a,history:e,observer:d,$sticky:null,paths:null,controls:null};k(a);a.$sticky=a.$root.find('[data-sticky="true"]');0<a.$sticky.length&&c(a,a.$sticky);f(a);return jQuery.extend(this,a)};jQuery.fn.jplist.ui.panel.controllers.PanelController=function(a,b,e,c){a=new g(a,b,e,c);this.paths=a.paths;this.history=a.history;this.controls=a.controls}})();(function(){var d=function(c,b,a,e){return jQuery.extend(this,{options:c,observer:b,history:a,$root:e})};d.prototype.create=function(c){var b=null,a,e,d,f,g,h,l,m;a=c.attr("data-control-type");g=f=d=!0;h=!1;m=l=null;(e=c.attr("data-control-deep-link"))&&"false"===e.toString()&&(d=!1);(e=c.attr("data-control-storage"))&&"false"===e.toString()&&(f=!1);(e=c.attr("data-control-animation"))&&"false"===e.toString()&&(g=!1);(e=c.attr("data-control-animate-to-top"))&&"true"===e.toString()&&(h=!0);e={};jQuery.fn.jplist.controlTypes[a]&&
...
a.prototype.setDeepLinks=function(a){var d,f,g,h=[],l;for(l=0;l<a.length;l++){d=a[l];f=d.controlName;var m=[];g=void 0;for(var n=0;n<this.controls.length;n++)g=this.controls[n],g.name===f&&m.push(g);f=m;for(m=0;m<f.length;m++)g=f[m],jQuery.isFunction(g.getStatusByDeepLink)&&(g=g.getStatusByDeepLink(d.propName,d.propValue))&&h.push(g)}d=b(this,!1);for(l=0;l<h.length;l++)c(d,h[l]);this.observer.trigger(this.observer.events.knownStatusesChanged,[d]);this.observer.trigger(this.observer.events.statusesChangedByDeepLinks,
[d,h,a])};a.prototype.setStatuses=function(a,b){for(var c,d,h=0;h<a.length;h++){c=a[h];d=c.name;for(var l=c.action,m=[],n=void 0,q=0;q<this.controls.length;q++)n=this.controls[q],n.name===d&&n.action===l&&m.push(n);d=m;for(l=0;l<d.length;l++)jQuery.isFunction(d[l].setStatus)&&d[l].setStatus(c,b)}};a.prototype.getDeepLinksUrl=function(){var a,b="",b=[],c="";a=this.controls;for(var d=[],h,l,m=0;m<a.length;m++){h=a[m];l=!0;for(var n=0;n<d.length;n++)if(d[n].name===h.name&&d[n].action===h.action){l=!1;
break}l&&d.push(h)}for(h=0;h<d.length;h++)a=d[h],jQuery.isFunction(a.getDeepLink)&&(c=jQuery.trim(a.getDeepLink())),""!==c&&-1===jQuery.inArray(c,b)&&b.push(c);return b=b.join(this.options.delimiter1)};a.prototype.getStatuses=function(a){return b(this,a)};a.prototype.getPaths=function(){var a,b=[],c;c=new d.dom.collections.DataItemMemberPathCollection(this.options,this.observer);for(var g=0;g<this.controls.length;g++)a=this.controls[g],jQuery.isFunction(a.getPaths)&&(a.getPaths(b),c.addRange(b));
return c.paths};a.prototype.add=function(a){(a=this.controlFactory.create(a))&&this.controls.push(a)};jQuery.fn.jplist.ui.panel.collections.ControlsCollection=function(b,c,d,g,h){return new a(b,c,d,g,h)}})();(function(){var d=function(a){var b=[];a=jQuery();jQuery(document).find("[data-control-type]").each(function(){var a=jQuery(this),c=a.attr("data-control-type");c&&(jQuery.fn.jplist.controlTypes[c]&&jQuery.fn.jplist.controlTypes[c].dropdown)&&b.push(a)});for(var c=0;c<b.length;c++)a=a.add(b[c]);return a},c=function(a){var b=d(a);0<b.length&&(jQuery(document).click(function(){b.find("ul").hide()}),jQuery(document).off(a.DROPDOWN_CLOSE_EVENT).on(a.DROPDOWN_CLOSE_EVENT,function(a,c){b.each(function(){jQuery(this).is(c)||
