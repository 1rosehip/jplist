...
*/
(function(){jQuery.fn.jplist.ui.controls.TextboxDTO=function(d,f,b){return{path:d,ignore:b,value:f,filterType:"TextFilter"}}})();(function(){var d=function(a,c){var e,b;e=a.$control.attr("data-path");b=c?"":a.$control.val();e=new jQuery.fn.jplist.ui.controls.TextboxDTO(e,b,a.params.ignore);return new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,e,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking)},f=function(a){if(a.params.$button&&0<a.params.$button.length)a.params.$button.on("click",function(c){c.preventDefault();a.history.addStatus(d(a,!1));a.observer.trigger(a.observer.events.unknownStatusesChanged,
[!1]);return!1});else a.$control.on(a.params.eventName,function(){a.history.addStatus(d(a,!1));a.observer.trigger(a.observer.events.unknownStatusesChanged,[!1])})},b=function(a){a.params={path:a.$control.attr("data-path"),dataButton:a.$control.attr("data-button"),ignore:a.$control.attr("data-ignore")||"[~!@#$%^&*()+=`'\"/\\_]+",eventName:a.$control.attr("data-event-name")||"keyup",$button:null};a.params.dataButton&&(a.params.$button=jQuery(a.params.dataButton));f(a);return jQuery.extend(this,a)};
