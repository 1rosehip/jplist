/**
* jPList - jQuery Data Grid Controls 0.0.18 - http://jplist.com 
...
function(a){return new f(a)};jQuery.fn.jplist.controlTypes["date-picker-filter"]={className:"DatePickerFilter",options:{}}})();(function(){jQuery.fn.jplist.ui.controls.RangeSliderDTO=function(e,g,h,f,a){return{path:e,type:"number",filterType:"range",min:g,max:h,prev:f,next:a}}})();(function(){var e=function(a,c){var b=null,d,e,f,g,b=a.$control.attr("data-path").toString();d=a.params.$uiSlider.slider("option","min");e=a.params.$uiSlider.slider("option","max");f=a.params.$uiSlider.slider("values",0);g=a.params.$uiSlider.slider("values",1);b=new jQuery.fn.jplist.ui.controls.RangeSliderDTO(b,d,e,f,g);return b=new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,b,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking)},g=function(a){a.params.$uiSlider.on("slidechange",
