...
*/
(function(){jQuery.fn.jplist.ui.controls.DatePickerRangeFilterDTO=function(e,g,h,f){e={path:e,format:g,filterType:"dateRange",prev_year:"",prev_month:"",prev_day:"",next_year:"",next_month:"",next_day:""};h&&(e.prev_year=h.getFullYear(),e.prev_month=h.getMonth(),e.prev_day=h.getDate());f&&(e.next_year=f.getFullYear(),e.next_month=f.getMonth(),e.next_day=f.getDate());return e}})();(function(){var e=function(a){var b={},c,d;c=a.$control.find('[data-type="prev"]');d=a.$control.find('[data-type="next"]');a.$control.data("jplist-datepicker-range-prev",c);a.$control.data("jplist-datepicker-range-next",d);c.off().change(function(){""===jQuery.trim(jQuery(this).val())&&(a.history.addStatus(g(a,!1)),a.observer.trigger(a.observer.events.unknownStatusesChanged,[!1]))});d.off().change(function(){""===jQuery.trim(jQuery(this).val())&&(a.history.addStatus(g(a,!1)),a.observer.trigger(a.observer.events.unknownStatusesChanged,
...
b.data.next_month+this.options.delimiter2+b.data.next_day)));return a};f.prototype.getStatusByDeepLink=function(a,b){var c=null,d;if(this.inDeepLinking&&(c=g(this,!0),c.data))switch(a){case "prev":d=b.split(this.options.delimiter2);3===d.length&&(c.data.prev_year=d[0],c.data.prev_month=d[1],c.data.prev_day=d[2]);break;case "next":d=b.split(this.options.delimiter2),3===d.length&&(c.data.next_year=d[0],c.data.next_month=d[1],c.data.next_day=d[2])}return c};f.prototype.getPaths=function(a){var b;if(b=
this.$control.attr("data-path").toString())b=new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(b,"datetime"),a.push(b)};f.prototype.setStatus=function(a,b){var c,d,e;d=this.$control.data("jplist-datepicker-range-prev");e=this.$control.data("jplist-datepicker-range-next");jQuery.isNumeric(a.data.prev_year)&&jQuery.isNumeric(a.data.prev_month)&&jQuery.isNumeric(a.data.prev_day)?(c=new Date(a.data.prev_year,a.data.prev_month,a.data.prev_day),d.datepicker("setDate",c)):d.val("");jQuery.isNumeric(a.data.next_year)&&
...
function(a){return new f(a)};jQuery.fn.jplist.controlTypes["date-picker-filter"]={className:"DatePickerFilter",options:{}}})();(function(){jQuery.fn.jplist.ui.controls.RangeSliderDTO=function(e,g,h,f,a){return{path:e,type:"number",filterType:"range",min:g,max:h,prev:f,next:a}}})();(function(){var e=function(a,b){var c=null,d,e,f,g,c=a.$control.attr("data-path").toString();d=a.params.$uiSlider.slider("option","min");e=a.params.$uiSlider.slider("option","max");b?(f=d,g=e):(f=a.params.$uiSlider.slider("values",0),g=a.params.$uiSlider.slider("values",1));c=new jQuery.fn.jplist.ui.controls.RangeSliderDTO(c,d,e,f,g);return c=new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,c,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking)},g=function(a){a.params.$uiSlider.on("slidechange",
