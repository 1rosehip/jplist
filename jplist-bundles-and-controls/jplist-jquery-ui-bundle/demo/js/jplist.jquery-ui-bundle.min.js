...
[!1]))});b.onSelect=function(b,c){a.history.addStatus(g(a,!1));a.observer.trigger(a.observer.events.unknownStatusesChanged,[!1])};a.params.datepickerFunc(c,b);a.params.datepickerFunc(d,b);(b=c.attr("value"))&&c.datepicker("setDate",b);(c=d.attr("value"))&&d.datepicker("setDate",c)},g=function(a,b){var c=null,d=c=null,e=null,f;f=a.$control.attr("data-path").toString();c=a.$control.attr("data-datetime-format").toString();d=a.$control.data("jplist-datepicker-range-prev");e=a.$control.data("jplist-datepicker-range-next");
d=d.datepicker("getDate");e=e.datepicker("getDate");c=new jQuery.fn.jplist.ui.controls.DatePickerRangeFilterDTO(f,c,d,e);return c=new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,c,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking)},h=function(a){var b=a.$control.attr("data-datepicker-func");jQuery.isFunction(jQuery.fn.jplist.settings[b])&&(a.params.datepickerFunc=jQuery.fn.jplist.settings[b])},f=function(a){a.params={datepickerFunc:function(){}};h(a);e(a);return jQuery.extend(this,
...
(""!==a&&(a+=this.options.delimiter1),a+=this.name+this.options.delimiter0+"next="+b.data.next_year+this.options.delimiter2+b.data.next_month+this.options.delimiter2+b.data.next_day)));return a};f.prototype.getStatusByDeepLink=function(a,b){var c=null,d;if(this.inDeepLinking&&(c=g(this,!0),c.data))switch(a){case "prev":d=b.split(this.options.delimiter2);3===d.length&&(c.data.prev_year=d[0],c.data.prev_month=d[1],c.data.prev_day=d[2],delete c.data.next_year,delete c.data.next_month,delete c.data.next_day);
break;case "next":d=b.split(this.options.delimiter2),3===d.length&&(c.data.next_year=d[0],c.data.next_month=d[1],c.data.next_day=d[2],delete c.data.prev_year,delete c.data.prev_month,delete c.data.prev_day)}return c};f.prototype.getPaths=function(a){var b;if(b=this.$control.attr("data-path").toString())b=new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(b,"datetime"),a.push(b)};f.prototype.setStatus=function(a,b){var c,d,e;d=this.$control.data("jplist-datepicker-range-prev");e=this.$control.data("jplist-datepicker-range-next");
