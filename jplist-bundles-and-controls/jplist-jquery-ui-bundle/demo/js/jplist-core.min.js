...
b=this.pagesNumber;this.nextPage=0===b?0:c>=b-1?b-1:c+1}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.autocompleteFilter=function(c,b,e,a,d){var f=[],g,h;if(jQuery.isNumeric(c)&&jQuery.isNumeric(b)&&google&&jQuery.fn.jlocator&&jQuery.fn.jlocator.store){c=new google.maps.LatLng(c,b);for(var k=0;k<a.length;k++)b=a[k],g=new jQuery.fn.jlocator.store(b.jqElement,{}),h=g.country?jQuery.trim(g.country.toLowerCase())==jQuery.trim(e.toLowerCase()):!1,g=google.maps.geometry.spherical.computeDistanceBetween(c,g.latlng),(g<=d||h)&&f.push(b);return f}return a}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.dateFilter=function(c,b,e,a,d,f){for(var g,h,k=[],l=0;l<d.length;l++)if(g=d[l],h=g.findPathitem(a))if(!jQuery.isNumeric(c)||!jQuery.isNumeric(b)||!jQuery.isNumeric(e))k.push(g);else if((h=jQuery.fn.jplist.domain.dom.services.HelperService.formatDateTime(h.text,f))&&jQuery.isFunction(h.getFullYear))h.setHours(0),h.setMinutes(0),h.setSeconds(0),h.getFullYear()===c&&(h.getMonth()===b&&h.getDate()===e)&&k.push(g);return k}})();(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.dateRangeFilter=function(c,b,e,a,d,f,g,h,k){for(var l=[],n,m,q,p,r=0;r<b.length;r++)if(n=b[r],m=n.findPathitem(c))if(q=!jQuery.isNumeric(a)||!jQuery.isNumeric(d)||!jQuery.isNumeric(f),p=!jQuery.isNumeric(g)||!jQuery.isNumeric(h)||!jQuery.isNumeric(k),q||p)l.push(n);else if((p=jQuery.fn.jplist.domain.dom.services.HelperService.formatDateTime(m.text,e))&&jQuery.isFunction(p.getFullYear))m=new Date(a,d,f),q=new Date(g,h,k),p.setHours(0),
