(function(){
	...
	*/
	var getPaths = function(context, paths){
		...
		path = new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(context.params.autocompleteParams.dataPath, dataType);
	...
	*/
	var Init = function(context){
		...
		//init data source
		context.params.dataSource = new jQuery.fn.jplist.ui.controls.AutocompleteDataSource(
		...
		//init view
		context.params.view = new jQuery.fn.jplist.ui.controls.AutocompleteView(
			context.$control
			,context.params.scopeObserver
			,context.params.autocompleteParams
		);
	...
	* @param {Object} context
	*/
	jQuery.fn.jplist.ui.controls.Autocomplete = function(context){
