;(function(){
	...
	*/
	var getDataDOM = function(context, inputValue){
		...
		if(jQuery.trim(inputValue) && dataitems){
			...
			path = new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(context.params.dataPath, null);
			
			dataview = jQuery.fn.jplist.domain.dom.services.FiltersService.textFilter(inputValue, path, dataitems, context.params.ignore, 'contains');
	...
	* @param {Object} autocompleteParams
	*/
	jQuery.fn.jplist.ui.controls.AutocompleteDataSource = function(scopeObserver, $root, options, autocompleteParams){
