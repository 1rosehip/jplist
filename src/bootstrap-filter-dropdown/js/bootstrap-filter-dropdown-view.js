;(function(){
	...
	*/
	var getStatus = function(context, isDefault){
		...
		data = new jQuery.fn.jplist.ui.controls.BootFilterDropdownDTO(
			$btn.attr('data-path')
		);
	...
	var getPaths = function(context, paths){
		...
		context.params.$buttons.each(function(){
			...
			if(jqPath && jQuery.trim(jqPath) !== ''){
			    ...
			    //init path
				path = new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(jqPath, $btn.attr('data-type'));
				paths.push(path);
			}
		});
	};
	...
	* @param {Object} context
	*/
	jQuery.fn.jplist.ui.controls.BootFilterDropdown = function(context){
