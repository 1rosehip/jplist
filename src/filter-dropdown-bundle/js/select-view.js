(function(){
	...
	*/
	var getStatus = function(context, isDefault){
		...
		data = new jQuery.fn.jplist.controls.DropdownFilterDTO($option.attr('data-path'), $option.attr('data-type'));
	...
	* @param {Object} context
	*/
	jQuery.fn.jplist.controls.FilterSelect = function(context){
