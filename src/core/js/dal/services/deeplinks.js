...
;(function(){
	...
	*/
	jQuery.fn.jplist.dal.services.DeepLinksService.getUrlParams = function(options){
	...
	*/
	jQuery.fn.jplist.dal.services.DeepLinksService.updateUrlPerControls = function(options, deepLinkUrl){
