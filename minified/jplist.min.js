/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
...
c)}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel=function(b,f){this.jqPath=b;this.dataType=f};jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel.prototype.isEqual=function(b,f){var c=!1;f?this.jqPath===b.jqPath&&(c=!0):this.jqPath===b.jqPath&&this.dataType===b.dataType&&(c=!0);return c}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){jQuery.fn.jplist.domain.dom.models.DataItemMemberModel=function(b,f){this.$element=b;this.path=f;this.text=b.text();this.html=b.html()}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(b,c,a){a={html:null,pathitems:[],$item:b,index:a};a.html=jQuery.fn.jplist.domain.dom.services.HelperService.getOuterHtml(b);var e,d;b=[];for(var g=0;g<c.length;g++)e=c[g],d=a.$item.find(e.jqPath),0<d.length&&(e=new jQuery.fn.jplist.domain.dom.models.DataItemMemberModel(d,e),b.push(e));a.pathitems=b;return jQuery.extend(this,a)};b.prototype.findPathitem=function(b){for(var c=null,a,e=0;e<this.pathitems.length;e++)if(a=this.pathitems[e],a.path.isEqual(b,!0)){c=a;break}return c};
...
f=this.pagesNumber;this.nextPage=0===f?0:b>=f-1?f-1:b+1}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){jQuery.fn.jplist.domain.dom.services.PaginationGoogleService=function(b,f,c){c=Number(c);isNaN(c)&&(c=0);c=this.itemsNumber=c;null===f?f=c:(f=Number(f),isNaN(f)&&(f=c));this.itemsOnPage=f;f=(f=this.itemsOnPage)?Math.ceil(this.itemsNumber/f):0;f=this.pagesNumber=f;b=Number(b);isNaN(b)&&(b=0);b>f-1&&(b=0);this.currentPage=b;this.start=this.currentPage*this.itemsOnPage;b=this.itemsNumber;f=this.start+this.itemsOnPage;f>b&&(f=b);this.end=f;b=this.currentPage;this.prevPage=0>=b?0:b-1;b=this.currentPage;
f=this.pagesNumber;this.nextPage=0===f?0:b>=f-1?f-1:b+1}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
...
(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.pathFilter=function(b,f){for(var c,a,e=[],d=0;d<f.length;d++)c=f[d],"default"===b.jqPath?e.push(c):(a=c.findPathitem(b))&&e.push(c);return e}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.pathGroupFilter=function(b,f){var c,a=[],e,d=[];if(0>=b.length)return f;for(e=0;e<b.length;e++)c=b[e],c=new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(c,null),a.push(c);for(var g=0;g<f.length;g++){e=f[g];for(var k=0;k<a.length;k++)if(c=a[k],"default"===c.jqPath){d.push(e);break}else(c=e.findPathitem(c))&&d.push(e)}return d}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){jQuery.fn.jplist.domain.dom.services.FiltersService.rangeFilter=function(b,f,c,a,e,d){c=[];for(var g,k=jQuery.isNumeric(e),l=jQuery.isNumeric(d),h=0;h<f.length;h++)if(a=f[h],g=a.findPathitem(b))g=Number(g.text.replace(/[^-0-9\.]+/g,"")),isNaN(g)||(k&&l?g>=e&&g<=d&&c.push(a):k&&!l?g>=e&&c.push(a):!k&&l&&g<=d&&c.push(a));return c}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
...
a.replace("{year}","(.*)");(d=f(e,c))&&(d=b("{year}",d));e=a.replace("{day}","(.*)");(k=f(e,c))&&(k=b("{day}",k));e=a.replace("{month}","(.*)");(g=f(e,c))&&(g=b("{month}",g));e=a.replace("{hour}","(.*)");(l=f(e,c))&&(l=b("{hour}",l));e=a.replace("{min}","(.*)");(h=f(e,c))&&(h=b("{min}",h));e=a.replace("{sec}","(.*)");(e=f(e,c))&&(e=b("{sec}",e));if(!d||isNaN(d))d=1900;if(!g||isNaN(g))g=0;if(!k||isNaN(k))k=1;if(!l||isNaN(l))l=0;if(!h||isNaN(h))h=0;if(!e||isNaN(e))e=0;return new Date(d,g,k,l,h,e)}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){jQuery.fn.jplist.domain.server.models.DataItemModel=function(b,f){this.content="";this.dataType=f;this.count=0;this.dataType||(this.dataType="html");switch(this.dataType){case "html":var c=jQuery(b);0<c.length&&(this.content=c.html(),this.count=Number(c.attr("data-count"))||0);break;case "json":this.content=b.data,this.count=b.count}}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
...
a]);1>a.progress?f(a,e):b(a)},a.delay):b(a)},c=function(a,e,d){a={$scene:a,options:e,observer:d,start:null,progress:0,delay:null,handler:null};a.delay=1E3/a.options.fps;return jQuery.extend(this,a)};c.prototype.play=function(a){f(this,a)};c.prototype.stop=function(){b(this)};jQuery.fn.jplist.animation.Timeline=function(a,e,d){return new c(a,e,d)}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){jQuery.fn.jplist.animation.fade={};jQuery.fn.jplist.animation.fade.before=function(b,f,c,a){};jQuery.fn.jplist.animation.fade.effect=function(b,f,c,a,e){f.find(b.itemPath).css({opacity:(100-e)/100})};jQuery.fn.jplist.animation.fade.after=function(b,f,c,a){f.empty();a.css({opacity:1});f.append(a)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(a,d,g,b){a.observer.trigger(a.observer.events.setStatusesEvent,[g,d]);jQuery.isFunction(a.options.redrawCallback)&&a.options.redrawCallback(d,b,g)},f=function(a,d,g){var c=d.dataitemsToJqueryObject(),f=d.dataviewToJqueryObject(),h=!1,m,n=jQuery.extend(!0,{},a.options,{duration:0});0>=c.length||0>=f.length?(a.$noResults.removeClass("jplist-hidden"),a.$itemsBox.addClass("jplist-hidden"),b(a,d,g,f)):(a.$noResults.addClass("jplist-hidden"),a.$itemsBox.removeClass("jplist-hidden"),
...
a.options.effect&&(a.timeline=new jQuery.fn.jplist.animation.Timeline(a.$root,a.options,a.observer));c(a);return jQuery.extend(this,a)};jQuery.fn.jplist.ui.list.views.DOMView=function(e,d,g,b){return new a(e,d,g,b)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(b){b.observer.on(b.observer.events.renderStatusesEvent,function(a,e){b.storage.save(e);b.collection&&b.collection.applyStatuses(e);b.options.deepLinking&&b.observer.trigger(b.observer.events.changeUrlDeepLinksEvent,[])})},f=function(c,a,e,d,g){c={options:a,observer:e,$root:c,history:g,storage:new jQuery.fn.jplist.dal.Storage(c,a,e),collection:null,listView:null};c.listView=new jQuery.fn.jplist.ui.list.views.DOMView(c.$root,c.options,c.observer,c.history);d=d.paths;a=c.$root.find(c.options.itemsBox).eq(0).find(c.options.itemPath);
d=new jQuery.fn.jplist.domain.dom.collections.DataItemsCollection(c.options,c.observer,a,d);c.collection=d;b(c);return jQuery.extend(this,c)};jQuery.fn.jplist.ui.list.controllers.DOMController=function(b,a,e,d,g){return new f(b,a,e,d,g)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(b){b.observer.on(b.observer.events.renderList,function(a,e,d){var g="html";b.options.dataSource&&(b.options.dataSource.server&&b.options.dataSource.server.ajax)&&((g=b.options.dataSource.server.ajax.dataType)||(g="html"));b.storage.save(d);jQuery.fn.jplist.dal.services.URIService.get(d,b.options,function(a,e){var d=new jQuery.fn.jplist.domain.server.models.DataItemModel(a,g),f,n;n=(new jQuery.fn.jplist.app.dto.StatusesDTOCollection(b.options,b.observer,e)).getStatusesByAction("paging",
e);for(var p=0;p<n.length;p++)f=n[p],f.data.currentPage||(f.data.currentPage=0),f=new jQuery.fn.jplist.domain.dom.services.PaginationService(f.data.currentPage,f.data.number,d.count),n[p].data.paging=f;b.model.set(d,e)},function(a){},function(a){})})},f=function(c,a,e,d,g){d=new jQuery.fn.jplist.dal.Storage(c,a,e);var k=jQuery({});k.$root=null;k.events={modelChanged:"modelChanged"};g={options:a,observer:e,history:g,storage:d,scopeObserver:k,$root:c,view:null,model:null};g.model=new jQuery.fn.jplist.ui.list.models.DataItemModel(null,
null,g.scopeObserver);g.view=new jQuery.fn.jplist.ui.list.views.ServerView(c,a,e,g.scopeObserver,g.model,g.history);b(g);return jQuery.extend(this,g)};jQuery.fn.jplist.ui.list.controllers.ServerController=function(b,a,e,d,g){return new f(b,a,e,d,g)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(a,d,g){a.observer.trigger(a.observer.events.setStatusesEvent,[g,d]);a.options.deepLinking&&a.observer.trigger(a.observer.events.changeUrlDeepLinksEvent,[]);jQuery.isFunction(a.options.redrawCallback)&&a.options.redrawCallback(d,g)},f=function(a,d,g){var c=!1,f,h=jQuery.extend(!0,{},a.options,{duration:0});!d||""===jQuery.trim(d)?(a.$noResults.removeClass("jplist-hidden"),a.$itemsBox.addClass("jplist-hidden")):(a.$noResults.addClass("jplist-hidden"),a.$itemsBox.removeClass("jplist-hidden"));
a.options.effect?(a.history&&(f=a.history.getLastStatus())&&!f.inAnimation&&(c=!0),c=c?h:a.options,jQuery.fn.jplist.animation.drawItems(c,a.$itemsBox,null,jQuery(d),a.options.effect,a.timeline,function(){b(a,d,g)},a.observer)):(a.options.dataSource&&jQuery.isFunction(a.options.dataSource.render)?a.options.dataSource.render(d,g):a.$itemsBox.html(d),b(a,d,g))},c=function(a){a.observer.on(a.observer.events.renderStatusesEvent,function(d,g){a.$noResults.addClass("jplist-hidden");a.observer.trigger(a.observer.events.renderList,
[a,g])});a.scopeObserver.on(a.scopeObserver.events.modelChanged,function(d,g,b){a.$preloader&&a.$preloader.addClass("jplist-hidden");a.$itemsBox.removeClass("jplist-hidden");f(a,g.content,b)})},a=function(a,d,g,b,f,h){a={options:d,$root:a,observer:g,scopeObserver:b,model:f,history:h,$itemsBox:a.find(d.itemsBox).eq(0),$noResults:a.find(d.noResults),$preloader:null,timeline:null};a.options.effect&&(a.timeline=new jQuery.fn.jplist.animation.Timeline(a.$root,a.options,a.observer));c(a);return jQuery.extend(this,
a)};jQuery.fn.jplist.ui.list.views.ServerView=function(e,d,g,b,c,f){return new a(e,d,g,b,c,f)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){jQuery.fn.jplist.ui.list.models.DataItemModel=function(b,f,c){this.dataItem=b;this.statuses=f;this.scopeObserver=c};jQuery.fn.jplist.ui.list.models.DataItemModel.prototype.set=function(b,f){this.dataItem=b;this.statuses=f;this.scopeObserver.trigger(this.scopeObserver.events.modelChanged,[b,f])}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(a){var e=jQuery(window).scrollTop(),b;b=Number(a.data("top"));isNaN(b)||(e>b?a.addClass("jplist-sticky"):a.removeClass("jplist-sticky"))},f=function(a,e){e.each(function(){var a=jQuery(this),e=a.offset().top;a.data("top",e);b(a)});jQuery(window).scroll(function(){e.each(function(){b(jQuery(this))})})},c=function(a){a.observer.on(a.observer.events.setStatusesEvent,function(e,b,c){a.controls.setStatuses(b,!1);a.history.addList(b);jQuery.fn.jplist.info(a.options,"Set statuses event: ",
...
a(e);e.$sticky=e.$root.find('[data-sticky="true"]');0<e.$sticky.length&&f(e,e.$sticky);c(e);return jQuery.extend(this,e)};jQuery.fn.jplist.ui.panel.controllers.PanelController=function(a,g,b,c){a=new e(a,g,b,c);this.paths=a.paths;this.history=a.history;this.controls=a.controls}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(b,c,a,e){return jQuery.extend(this,{options:b,observer:c,history:a,$root:e})};b.prototype.create=function(b){var c=null,a,e,d,g,k,l,h,m;a=b.attr("data-control-type");k=g=d=!0;l=!1;m=h=null;(e=b.attr("data-control-deep-link"))&&"false"===e.toString()&&(d=!1);(e=b.attr("data-control-storage"))&&"false"===e.toString()&&(g=!1);(e=b.attr("data-control-animation"))&&"false"===e.toString()&&(k=!1);(e=b.attr("data-control-animate-to-top"))&&"true"===e.toString()&&(l=!0);if(e=this.options.controlTypes[a])e.className&&
...
[a])):(this.$control.find("li").removeClass("active"),b=this.$control.find('li:has([data-number="'+a.data.number+'"])'),0===b.length&&(b=this.$control.find('li:has([data-number="all"])')),b.addClass("active"),this.$control.find(".jplist-dd-panel").text(b.eq(0).text()))}};jQuery.fn.jplist.ui.controls.Dropdown=function(e){return new a(e)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(a,d){var b,c=null,f="",h="";b=a.$control.data("storage-status");if(d&&b)c=b;else switch(d?(b=a.$control.find('option[data-default="true"]').eq(0),0>=b.length&&(b=a.$control.find("option").eq(0))):b=a.$control.find("option:selected"),a.action){case "paging":c=new jQuery.fn.jplist.ui.controls.DropdownPaginationDTO(b.attr("data-number"));c=new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,c,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking);break;case "sort":f=
...
'"]'),0<c.length&&(c.get(0).selected=!0));break;case "paging":c=this.$control.find('option[data-number="'+a.data.number+'"]'),0===c.length&&(c=this.$control.find('option[data-number="all"]')),c.get(0).selected=!0}};jQuery.fn.jplist.ui.controls.Select=function(b){return new a(b)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
...
(function(){jQuery.fn.jplist.ui.controls.DropdownSortDTO=function(b,f,c,a,e){return{path:b,type:f,order:c,dateTimeFormat:a,ignore:e}}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(a,b){var d;d=null;var c;c=!1;d=a.$control.data("storage-status");if(!b||!d){d=a.$control.find("button[data-active]").eq(0);0>=d.length&&(d=a.$control.find("button").eq(0));d=b?0:Number(d.attr("data-number"))||0;if(c="true"===a.$control.attr("data-jump-to-start")||a.controlOptions.jumpToStart)(c=a.history.getLastStatus())&&("pagination"!==c.type&&"views"!==c.type)&&(d=0);c=Number(a.$control.attr("data-items-per-page"))||0;d=new jQuery.fn.jplist.ui.controls.PaginationDTO(d,
...
"currentPage"===a&&(d.data.currentPage=e)}return d};c.prototype.setStatus=function(a,b){this.inStorage&&b&&this.$control.data("storage-status",a);!this.inStorage&&b?(a.data.currentPage=0,this.history.addStatus(a),this.observer.trigger(this.observer.events.statusEvent,[a])):a.data&&a.data.paging&&this.params.view.build(a.data.paging)};jQuery.fn.jplist.ui.controls.Pagination=function(a){return new c(a)}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(b,a,e){var d;d='<div class="jplist-pagesbox" data-type="pagesbox">';for(var g=b;g<a;g++)d+='<button type="button" data-type="page" ',g===e&&(d+=' class="jplist-current" data-active="true" '),b=g+1,d+=' data-number="'+g+'" ',d+=">"+b+"</button> ";return d+"</div>"},f=function(b,a){var e={$control:b,options:a,$pagingprev:null,$pagingmid:null,$pagingnext:null,$jplistFirst:null,$jplistPrev:null,$jplistNext:null,$jplistLast:null,mode:b.attr("data-mode")},d,g,f,l;d=e.$control.attr("data-prev")||
...
this.$control.removeClass("jplist-one-page")}else this.$control.addClass("jplist-hidden");0===c.currentPage?this.$pagingprev.addClass("jplist-hidden"):this.$pagingprev.removeClass("jplist-hidden");c.currentPage==c.pagesNumber-1?this.$pagingnext.addClass("jplist-hidden"):this.$pagingnext.removeClass("jplist-hidden")};jQuery.fn.jplist.ui.controls.PaginationView=function(b,a){return new f(b,a)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){jQuery.fn.jplist.ui.controls.PaginationDTO=function(b,f){var c={currentPage:b,paging:null};f&&(c.number=f);return c}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(b){return jQuery.extend(this,b)};b.prototype.setStatus=function(b,c){var a,e;a=b.data.paging;!a||0>=a.pagesNumber?(this.$control.html(""),this.$control.addClass("jplist-empty")):(this.$control.removeClass("jplist-empty"),e=this.$control.attr("data-type"),e=e.replace("{current}",a.currentPage+1),e=e.replace("{pages}",a.pagesNumber),e=e.replace("{start}",a.start+1),e=e.replace("{end}",a.end),e=e.replace("{all}",a.itemsNumber),this.$control.html(e))};jQuery.fn.jplist.ui.controls.PaginationInfo=
...
null);a.push(b)};c.prototype.setStatus=function(a,b){this.inStorage&&b&&this.$control.data("storage-status",a);!this.inStorage&&b?(a.data.value="",this.observer.trigger(this.observer.events.statusEvent,[a])):a.data&&(a.data.value||(a.data.value=""),this.$control.val(a.data.value))};jQuery.fn.jplist.ui.controls.Textbox=function(a){return new c(a)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
...
(function(){jQuery.fn.jplist.ui.controls.TextboxDTO=function(b,f,c){return{path:b,ignore:c,value:f,filterType:"TextFilter"}}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(a,b){var d;d=null;d=a.params.defaultView;b&&a.params.storageStatus?d=a.params.storageStatus:(d=b?a.params.defaultView:a.params.currentView,d=new jQuery.fn.jplist.ui.controls.ViewsDTO(d),d=new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,d,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking));return d},f=function(a){a.params.$buttons.on("click",function(){var e=jQuery(this).attr("data-type");a.$root.removeClass(a.params.types.join(" ")).addClass(e);a.params.currentView=
...
this.params.currentView=this.params.defaultView,this.observer.trigger(this.observer.events.statusEvent,[a])):(this.$root.addClass(a.data.view),this.params.currentView=a.data.view))};jQuery.fn.jplist.ui.controls.Views=function(a){return new c(a)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
...
(function(){jQuery.fn.jplist.ui.controls.ViewsDTO=function(b){this.view=b}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(b){return jQuery.extend(this,b)};b.prototype.getStatus=function(b){b=new jQuery.fn.jplist.ui.controls.DefaultSortDTO(this.$control.attr("data-path"),this.$control.attr("data-type"),this.$control.attr("data-order"),this.$control.attr("data-datetime-format"),this.$control.attr("data-ignore"));return new jQuery.fn.jplist.app.dto.StatusDTO(this.name,this.action,this.type,b,this.inStorage,this.inAnimation,this.isAnimateToTop,this.inDeepLinking)};b.prototype.getPaths=function(b){var c,
a;c=this.$control.attr("data-path");a=this.$control.attr("data-type");c&&(c=new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(c,a),b.push(c))};jQuery.fn.jplist.ui.controls.DefaultSort=function(f){return new b(f)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
...
(function(){jQuery.fn.jplist.ui.controls.DefaultSortDTO=function(b,f,c,a,e){return{path:b,type:f,order:c,dateTimeFormat:a,ignore:e}}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(a,b){var d,c,f,l,h=null,m="";c=a.$control.data("path");l=a.$control.data("dataType");f=a.$control.data("dataText");d=a.$control.data("$countValue");switch(l){case "path":h=jQuery.fn.jplist.domain.dom.services.FiltersService.pathFilter(c,b);break;case "text":a.controlOptions&&a.controlOptions.ignore&&(m=a.controlOptions.ignore);h=jQuery.fn.jplist.domain.dom.services.FiltersService.textFilter(f,c,b,m);break;case "range":h=jQuery.fn.jplist.domain.dom.services.FiltersService.rangeFilter(c,
...
null),a.$control.data("path",b));a.$control.data("dataMode",k);a.$control.data("dataType",l);a.$control.data("dataPath",d);a.$control.data("dataText",c);a.$control.data("dataMin",h);a.$control.data("dataMax",m);f(a);return jQuery.extend(this,a)};jQuery.fn.jplist.ui.controls.Counter=function(a){return new c(a)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(a){var b,d={},c,k;b=a.controlOptions;c=a.$control.find('[data-type="prev"]');k=a.$control.find('[data-type="next"]');a.$control.data("jplist-datepicker-range-prev",c);a.$control.data("jplist-datepicker-range-next",k);c.off().change(function(){""===jQuery.trim(jQuery(this).val())&&(a.history.addStatus(f(a,!1)),a.observer.trigger(a.observer.events.forceRenderStatusesEvent,[!1]))});k.off().change(function(){""===jQuery.trim(jQuery(this).val())&&(a.history.addStatus(f(a,!1)),
...
jQuery.isNumeric(a.data.next_day)?(d=new Date(a.data.next_year,a.data.next_month,a.data.next_day),f.datepicker("setDate",d)):f.val("")};jQuery.fn.jplist.ui.controls.DatePickerRangeFilter=function(a){return new c(a)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
...
(function(){jQuery.fn.jplist.ui.controls.DatePickerRangeFilterDTO=function(b,f,c,a){b={path:b,format:f,filterType:"dateRange",prev_year:"",prev_month:"",prev_day:"",next_year:"",next_month:"",next_day:""};c&&(b.prev_year=c.getFullYear(),b.prev_month=c.getMonth(),b.prev_day=c.getDate());a&&(b.next_year=a.getFullYear(),b.next_month=a.getMonth(),b.next_day=a.getDate());return b}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(a,b){var d=null,c,f,l,h;b&&a.params.storageStatus?d=a.params.storageStatus:(d=a.$control.attr("data-path").toString(),c=a.params.$uiSlider.slider("option","min"),f=a.params.$uiSlider.slider("option","max"),b?(l=c,h=f):(l=a.params.$uiSlider.slider("values",0),h=a.params.$uiSlider.slider("values",1)),d=new jQuery.fn.jplist.ui.controls.RangeSliderDTO(d,c,f,l,h),d=new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,d,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking));
...
(d=Number(a.data.prev),c=Number(a.data.next),!isNaN(d)&&!isNaN(c)&&(this.params.$uiSlider.slider("values",0)!=d&&this.params.$uiSlider.slider("values",0,d),this.params.$uiSlider.slider("values",1)!=c&&this.params.$uiSlider.slider("values",1,c)));this.params.controlOptions&&this.params.controlOptions.set_values(this.params.$uiSlider,this.params.$prev,this.params.$next)};jQuery.fn.jplist.ui.controls.RangeSlider=function(a){return new c(a)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
...
"text"),a.push(b))};c.prototype.setStatus=function(a,b){this.inStorage&&b&&this.$control.data("storage-status",a);(this.params.selected=a.data.selected)?this.$control.addClass("jplist-selected"):this.$control.removeClass("jplist-selected")};jQuery.fn.jplist.ui.controls.ButtonTextFilter=function(a){return new c(a)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
...
path:h[1]})}return e};e.prototype.getPaths=function(a){f(this,a)};e.prototype.setStatus=function(a,b){c(this,a,b)};jQuery.fn.jplist.ui.controls.ButtonTextFilterGroup=function(a){return new e(a)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
...
a)};e.prototype.setStatus=function(a,b){c(this,a,b)};jQuery.fn.jplist.ui.controls.CheckboxGroupFilter=function(a){return new e(a)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
...
"number"),a.push(b))};c.prototype.setStatus=function(a,b){this.inStorage&&b&&this.$control.data("storage-status",a);(this.params.selected=a.data.selected)?this.$control.addClass("jplist-selected"):this.$control.removeClass("jplist-selected")};jQuery.fn.jplist.ui.controls.RangeSliderToggleFilter=function(a){return new c(a)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(a){!a.history.statusesQueue||0>=a.history.statusesQueue.length?a.$control.addClass("jplist-disabled"):a.$control.removeClass("jplist-disabled")},f=function(a){a.observer.on(a.observer.events.setStatusesEvent,function(c,d,f){b(a)});a.$control.on("click",function(){var c,d,f;a.history.popStatus();a.history.popList();c=a.history.getLastStatus();if((f=a.history.getLastList()||[])&&c){for(var k=0;k<f.length;k++)d=f[k],d.name===c.name&&d.action===c.action&&jQuery.extend(!0,f[k],
c);a.observer.trigger(a.observer.events.renderStatusesEvent,[f])}else a.observer.trigger(a.observer.events.forceRenderStatusesEvent,[!0]);b(a)})},c=function(a){b(a);f(a);return jQuery.extend(this,a)};jQuery.fn.jplist.ui.controls.BackButton=function(a){return new c(a)}})();/*
 jPList - jQuery Data Grid Controls 5.1.18 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
