/*
 jPList - jQuery Data Grid Controls 5.0.1111 - http://jplist.com 
...
a.replace("{year}","(.*)");(d=f(e,c))&&(d=b("{year}",d));e=a.replace("{day}","(.*)");(k=f(e,c))&&(k=b("{day}",k));e=a.replace("{month}","(.*)");(g=f(e,c))&&(g=b("{month}",g));e=a.replace("{hour}","(.*)");(l=f(e,c))&&(l=b("{hour}",l));e=a.replace("{min}","(.*)");(h=f(e,c))&&(h=b("{min}",h));e=a.replace("{sec}","(.*)");(e=f(e,c))&&(e=b("{sec}",e));if(!d||isNaN(d))d=1900;if(!g||isNaN(g))g=0;if(!k||isNaN(k))k=1;if(!l||isNaN(l))l=0;if(!h||isNaN(h))h=0;if(!e||isNaN(e))e=0;return new Date(d,g,k,l,h,e)}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){jQuery.fn.jplist.domain.serverHTML.models.DataItemModel=function(b){b=jQuery(b);this.format=this.html="";this.count=0;0<b.length&&(this.html=b.html(),this.format=b.attr("data-format"),this.count=Number(b.attr("data-count"))||0)}})();/*
 jPList - jQuery Data Grid Controls 5.0.1111 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
...
d=new jQuery.fn.jplist.domain.dom.collections.DataItemsCollection(c.options,c.observer,a,d);c.collection=d;b(c);return jQuery.extend(this,c)};jQuery.fn.jplist.ui.list.controllers.DOMController=function(b,a,e,d,g){return new f(b,a,e,d,g)}})();/*
 ...
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
*/
(function(){var b=function(b){b.observer.on(b.observer.events.renderList,function(a,e,d){b.storage.save(d);jQuery.fn.jplist.dal.services.URIService.get(d,b.options,function(a,e){var d=new jQuery.fn.jplist.domain.serverHTML.models.DataItemModel(a),f,m;m=(new jQuery.fn.jplist.app.dto.StatusesDTOCollection(b.options,b.observer,e)).getStatusesByAction("paging",e);for(var n=0;n<m.length;n++)f=m[n],f.data.currentPage||(f.data.currentPage=0),f=new jQuery.fn.jplist.domain.dom.services.PaginationService(f.data.currentPage,
