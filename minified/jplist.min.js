/*
 jPList - jQuery Data Grid Controls 5.1.5 - http://jplist.com 
...
g,b){a.$preloader&&a.$preloader.addClass("jplist-hidden");a.$itemsBox.removeClass("jplist-hidden");f(a,g.content,b)})},a=function(a,d,g,b,f,h){a={options:d,$root:a,observer:g,scopeObserver:b,model:f,history:h,$itemsBox:a.find(d.itemsBox).eq(0),$noResults:a.find(d.noResults),$preloader:null,timeline:null};a.options.effect&&(a.timeline=new jQuery.fn.jplist.animation.Timeline(a.$root,a.options,a.observer));c(a);return jQuery.extend(this,a)};jQuery.fn.jplist.ui.list.views.ServerHTMLView=function(e,d,
g,b,c,f){return new a(e,d,g,b,c,f)}})();/*
 jPList - jQuery Data Grid Controls 5.1.5 - http://jplist.com 
 Copyright 2014 Miriam Zusin. All rights reserved.
 For non-commercial, personal, or open source projects and applications, you may use jPList for free under the terms of the GPL V3 License (https://gnu.org/licenses/gpl.html)
 If your project generates any type of income, e.g. sells products, ads, services or just represents a commercial company, you should get a commercial license at http://www.binpress.com
