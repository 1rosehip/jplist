/*
 jPList - jQuery Data Grid Controls 5.1.73 - http://jplist.com 
...
options:{ignore:"[~!@#$%^&*()+=`'\"/\\_]+"}},"radio-buttons-filters":{className:"RadioButtonsFilter",options:{}},"range-filter":{className:"RangeSliderToggleFilter",options:{}},"back-button":{className:"BackButton",options:{}},preloader:{className:"Preloader",options:{}}},itemControlTypes:{"star-rating":{className:"StarRating",options:{}}}},b);a.history=new jQuery.fn.jplist.app.History(a.$root,a.options,a.observer);a.panel=new jQuery.fn.jplist.ui.panel.controllers.PanelController(c,a.options,a.history,
a.observer);a.options.dataSource=a.options.dataSource||{};a.options.dataSource.type=a.options.dataSource.type||"html";jQuery.fn.jplist.info(a.options,"Data Source Type: ",a.options.dataSource.type);switch(a.options.dataSource.type){case "html":new jQuery.fn.jplist.ui.list.controllers.DOMController(a.$root,a.options,a.observer,a.panel,a.history);break;case "server":jQuery.fn.jplist.info(a.options,"Data Source: ",a.options.dataSource),new jQuery.fn.jplist.ui.list.controllers.ServerController(a.$root,
a.options,a.observer,a.panel,a.history)}var e=[],d=!1;a.options.deepLinking?(jQuery.fn.jplist.info(a.options,"Deep linking enabled",""),a.observer.trigger(a.observer.events.setDeepLinksEvent,[])):(d="cookies"===a.options.storage||"localstorage"===a.options.storage&&jQuery.fn.jplist.dal.services.LocalStorageService.supported())?(jQuery.fn.jplist.info(a.options,"Storage enabled: ",a.options.storage),"cookies"===a.options.storage&&(e=jQuery.fn.jplist.dal.services.CookiesService.restoreCookies(a.options.storageName)),
...
jQuery(this).data("jplist",c)})};jQuery.fn.jplist.app=jQuery.fn.jplist.app||{};jQuery.fn.jplist.app.services=jQuery.fn.jplist.app.services||{};jQuery.fn.jplist.app.services.DTOMapperService=jQuery.fn.jplist.app.services.DTOMapperService||{};jQuery.fn.jplist.app.dto=jQuery.fn.jplist.app.dto||{};jQuery.fn.jplist.domain=jQuery.fn.jplist.domain||{};jQuery.fn.jplist.domain.dom=jQuery.fn.jplist.domain.dom||{};jQuery.fn.jplist.domain.dom.models=jQuery.fn.jplist.domain.dom.models||{};jQuery.fn.jplist.domain.dom.collections=
jQuery.fn.jplist.domain.dom.collections||{};jQuery.fn.jplist.domain.dom.services=jQuery.fn.jplist.domain.dom.services||{};jQuery.fn.jplist.domain.dom.services.FiltersService=jQuery.fn.jplist.domain.dom.services.FiltersService||{};jQuery.fn.jplist.domain.dom.services.SortService=jQuery.fn.jplist.domain.dom.services.SortService||{};jQuery.fn.jplist.domain.dom.services.pagination=jQuery.fn.jplist.domain.dom.services.pagination||{};jQuery.fn.jplist.domain.server=jQuery.fn.jplist.domain.server||{};jQuery.fn.jplist.domain.server.models=
jQuery.fn.jplist.domain.server.models||{};jQuery.fn.jplist.dal=jQuery.fn.jplist.dal||{};jQuery.fn.jplist.dal.services=jQuery.fn.jplist.dal.services||{};jQuery.fn.jplist.ui=jQuery.fn.jplist.ui||{};jQuery.fn.jplist.ui.list=jQuery.fn.jplist.ui.list||{};jQuery.fn.jplist.ui.list.models=jQuery.fn.jplist.ui.list.models||{};jQuery.fn.jplist.ui.list.controllers=jQuery.fn.jplist.ui.list.controllers||{};jQuery.fn.jplist.ui.list.collections=jQuery.fn.jplist.ui.list.collections||{};jQuery.fn.jplist.ui.list.views=
jQuery.fn.jplist.ui.list.views||{};jQuery.fn.jplist.ui.controls=jQuery.fn.jplist.ui.controls||{};jQuery.fn.jplist.ui.itemControls=jQuery.fn.jplist.ui.itemControls||{};jQuery.fn.jplist.ui.statuses=jQuery.fn.jplist.ui.statuses||{};jQuery.fn.jplist.ui.panel=jQuery.fn.jplist.ui.panel||{};jQuery.fn.jplist.ui.panel.controllers=jQuery.fn.jplist.ui.panel.controllers||{};jQuery.fn.jplist.ui.panel.collections=jQuery.fn.jplist.ui.panel.collections||{}})();(function(){jQuery.fn.jplist.app.dto.StatusDTO=function(b,f,c,a,e,d,g,h){this.action=f;this.name=b;this.type=c;this.data=a;this.inStorage=e;this.inAnimation=d;this.isAnimateToTop=g;this.inDeepLinking=h}})();(function(){var b=function(b,c,a){return jQuery.extend(this,{options:c,observer:a,$root:b,statusesQueue:[],listStatusesQueue:[]})};b.prototype.addStatus=function(b){this.statusesQueue.push(b);this.statusesQueue.length>this.options.historyLength&&this.statusesQueue.shift()};b.prototype.getLastStatus=function(){var b=null;0<this.statusesQueue.length&&(b=this.statusesQueue[this.statusesQueue.length-1]);return b};b.prototype.popStatus=function(){var b=null;0<this.statusesQueue.length&&(b=this.statusesQueue.pop());
...
c=jQuery.fn.jplist.domain.dom.services.HelperService.getOuterHtml(e),d===c){g=b;break}return g},h=function(a,e){var d;d=g(a,e);-1!==d&&(a.dataitems.splice(d,1),a.observer.trigger(a.observer.events.delItemEvent,[e,a.dataitems]))},l=function(a,e){e.each(function(){h(a,jQuery(this))})},k=function(a,e,d,g){e=new jQuery.fn.jplist.domain.dom.models.DataItemModel(e,d,g);a.dataitems.push(e);a.observer.trigger(a.observer.events.addItemEvent,[e,a.dataitems])},m=function(a,e,d,g){for(var b;d<e.length;d++)b=
e.eq(d),k(a,b,g,d),d+1<e.length&&0===d%50&&window.setTimeout(function(){m(a,e,d,g)},0)},n=function(a,e,g,b){a={dataitems:[],dataview:[],options:a,observer:e};0<g.length&&(m(a,g,0,b),d(a));a.observer.trigger(a.observer.events.collectionReadyEvent,[a]);return jQuery.extend(this,a)};n.prototype.applyStatuses=function(a){d(this);c(this,a);b(this,a);f(this,a);this.observer.trigger(this.observer.events.renderList,[this,a])};n.prototype.filter=function(a){b(this,a)};n.prototype.sort=function(a){c(this,a)};
...
a.options.effect&&(a.timeline=new jQuery.fn.jplist.animation.Timeline(a.$root,a.options,a.observer));c(a);return jQuery.extend(this,a)};jQuery.fn.jplist.ui.list.views.DOMView=function(e,d,g,b){return new a(e,d,g,b)}})();(function(){var b=function(b){b.observer.on(b.observer.events.renderStatusesEvent,function(a,e){b.storage.save(e);b.collection&&b.collection.applyStatuses(e);b.options.deepLinking&&b.observer.trigger(b.observer.events.changeUrlDeepLinksEvent,[])})},f=function(c,a,e,d,g){c={options:a,observer:e,$root:c,history:g,storage:new jQuery.fn.jplist.dal.Storage(c,a,e),collection:null,itemControls:null,listView:null};c.listView=new jQuery.fn.jplist.ui.list.views.DOMView(c.$root,c.options,c.observer,c.history);
d=d.paths;a=c.$root.find(c.options.itemsBox).eq(0).find(c.options.itemPath);d=new jQuery.fn.jplist.domain.dom.collections.DataItemsCollection(c.options,c.observer,a,d);c.collection=d;c.itemControls=new jQuery.fn.jplist.ui.list.collections.ItemControlCollection(c.options,c.observer,c.history,c.$root,c.collection);b(c);return jQuery.extend(this,c)};jQuery.fn.jplist.ui.list.controllers.DOMController=function(b,a,e,d,g){return new f(b,a,e,d,g)}})();(function(){var b=function(b){b.observer.on(b.observer.events.renderList,function(a,e,d){var g="html";b.options.dataSource&&(b.options.dataSource.server&&b.options.dataSource.server.ajax)&&((g=b.options.dataSource.server.ajax.dataType)||(g="html"));b.storage.save(d);jQuery.fn.jplist.dal.services.URIService.get(d,b.options,function(a,e,d,f){a=new jQuery.fn.jplist.domain.server.models.DataItemModel(a,g,f.responseText);var n;d=(new jQuery.fn.jplist.app.dto.StatusesDTOCollection(b.options,b.observer,
e)).getStatusesByAction("paging",e);for(f=0;f<d.length;f++)n=d[f],n.data.currentPage||(n.data.currentPage=0),n=new jQuery.fn.jplist.domain.dom.services.PaginationService(n.data.currentPage,n.data.number,a.count),d[f].data.paging=n;b.model.set(a,e)},function(a){},function(a){})})},f=function(c,a,e,d,g){d=new jQuery.fn.jplist.dal.Storage(c,a,e);var h=jQuery({});h.$root=null;h.events={modelChanged:"modelChanged"};g={options:a,observer:e,history:g,storage:d,scopeObserver:h,$root:c,view:null,model:null};
g.model=new jQuery.fn.jplist.ui.list.models.DataItemModel(null,null,g.scopeObserver);g.view=new jQuery.fn.jplist.ui.list.views.ServerView(c,a,e,g.scopeObserver,g.model,g.history);b(g);return jQuery.extend(this,g)};jQuery.fn.jplist.ui.list.controllers.ServerController=function(b,a,e,d,g){return new f(b,a,e,d,g)}})();(function(){var b=function(a,d,g){a.observer.trigger(a.observer.events.setStatusesEvent,[g,d]);a.options.deepLinking&&a.observer.trigger(a.observer.events.changeUrlDeepLinksEvent,[]);jQuery.isFunction(a.options.redrawCallback)&&a.options.redrawCallback(d,g)},f=function(a,d,g){var c=!1,f,k=jQuery.extend(!0,{},a.options,{duration:0});!d.content||""===jQuery.trim(d.content)?(a.$noResults.removeClass("jplist-hidden"),a.$itemsBox.addClass("jplist-hidden")):(a.$noResults.addClass("jplist-hidden"),a.$itemsBox.removeClass("jplist-hidden"));
...
a.observer.trigger(a.observer.events.renderList,[a,g])});a.scopeObserver.on(a.scopeObserver.events.modelChanged,function(d,g,b){a.$preloader&&a.$preloader.addClass("jplist-hidden");a.$itemsBox.removeClass("jplist-hidden");f(a,g,b)})},a=function(a,d,g,b,f,k){a={options:d,$root:a,observer:g,scopeObserver:b,model:f,history:k,$itemsBox:a.find(d.itemsBox).eq(0),$noResults:a.find(d.noResults),$preloader:null,timeline:null};a.options.effect&&(a.timeline=new jQuery.fn.jplist.animation.Timeline(a.$root,a.options,
a.observer));c(a);return jQuery.extend(this,a)};jQuery.fn.jplist.ui.list.views.ServerView=function(e,d,g,b,c,f){return new a(e,d,g,b,c,f)}})();(function(){jQuery.fn.jplist.ui.list.models.DataItemModel=function(b,f,c){this.dataItem=b;this.statuses=f;this.scopeObserver=c};jQuery.fn.jplist.ui.list.models.DataItemModel.prototype.set=function(b,f){this.dataItem=b;this.statuses=f;this.scopeObserver.trigger(this.scopeObserver.events.modelChanged,[b,f])}})();(function(){var b=function(b,c,a,e){return jQuery.extend(this,{options:b,observer:c,history:a,$root:e})};b.prototype.create=function(b){var c=null,a,e,d=null,g=null;a=b.attr("data-control-type");if(e=this.options.itemControlTypes[a])e.className&&(d=jQuery.fn.jplist.ui.itemControls[e.className]),e.options&&(g=e.options);a={type:a,itemControlType:e,controlTypeClass:d,controlOptions:g};a=jQuery.extend(!0,a,{$control:b,history:this.history,observer:this.observer,options:this.options,$root:this.$root});
a.controlTypeClass&&jQuery.isFunction(a.controlTypeClass)&&(c=new a.controlTypeClass(a));return c};jQuery.fn.jplist.ui.list.ItemControlFactory=function(f,c,a,e){return new b(f,c,a,e)}})();(function(){var b=function(b){var a;if(b.dataitemsCollection&&b.dataitemsCollection.dataitems)for(var e=0;e<b.dataitemsCollection.dataitems.length;e++)if((a=b.dataitemsCollection.dataitems[e])&&a.jqElement&&0<a.jqElement.length)a=a.jqElement.find("[data-control-type]"),a.each(function(){var a=jQuery(this);(a=b.controlFactory.create(a))&&b.controls.push(a)})},f=function(c,a,e,d,g){g={options:c,observer:a,history:e,$root:d,dataitemsCollection:g,controls:[],controlFactory:null};g.controlFactory=new jQuery.fn.jplist.ui.list.ItemControlFactory(c,
a,e,d);b(g);return jQuery.extend(this,g)};jQuery.fn.jplist.ui.list.collections.ItemControlCollection=function(b,a,e,d,g){return new f(b,a,e,d,g)}})();(function(){var b=function(a){var e=jQuery(window).scrollTop(),b;b=Number(a.data("top"));isNaN(b)||(e>b?a.addClass("jplist-sticky"):a.removeClass("jplist-sticky"))},f=function(a,e){e.each(function(){var a=jQuery(this),e=a.offset().top;a.data("top",e);b(a)});jQuery(window).scroll(function(){e.each(function(){b(jQuery(this))})})},c=function(a){a.observer.on(a.observer.events.setStatusesEvent,function(e,b,c){a.controls.setStatuses(b,!1);a.history.addList(b);jQuery.fn.jplist.info(a.options,"Set statuses event: ",
...
a(e);e.$sticky=e.$root.find('[data-sticky="true"]');0<e.$sticky.length&&f(e,e.$sticky);c(e);return jQuery.extend(this,e)};jQuery.fn.jplist.ui.panel.controllers.PanelController=function(a,g,b,c){a=new e(a,g,b,c);this.paths=a.paths;this.history=a.history;this.controls=a.controls}})();(function(){var b=function(b,c,a,e){return jQuery.extend(this,{options:b,observer:c,history:a,$root:e})};b.prototype.create=function(b){var c=null,a,e,d,g,h,l,k,m;a=b.attr("data-control-type");h=g=d=!0;l=!1;m=k=null;(e=b.attr("data-control-deep-link"))&&"false"===e.toString()&&(d=!1);(e=b.attr("data-control-storage"))&&"false"===e.toString()&&(g=!1);(e=b.attr("data-control-animation"))&&"false"===e.toString()&&(h=!1);(e=b.attr("data-control-animate-to-top"))&&"true"===e.toString()&&(l=!0);if(e=this.options.controlTypes[a])e.className&&
(k=jQuery.fn.jplist.ui.controls[e.className]),e.options&&(m=e.options);a={type:a,action:b.attr("data-control-action"),name:b.attr("data-control-name"),inDeepLinking:d,inStorage:g,inAnimation:h,isAnimateToTop:l,controlType:e,controlTypeClass:k,controlOptions:m,paths:[]};a=jQuery.extend(!0,a,{$control:b,history:this.history,observer:this.observer,options:this.options,$root:this.$root});a.controlTypeClass&&jQuery.isFunction(a.controlTypeClass)&&(c=new a.controlTypeClass(a));return c};jQuery.fn.jplist.ui.panel.ControlFactory=
...
observer:d,history:g,$root:b,controlFactory:null,$controls:c,controls:[]};c.controlFactory=new jQuery.fn.jplist.ui.panel.ControlFactory(a,d,g,b);for(a=0;a<c.$controls.length;a++)g=c.$controls.eq(a),d=c,(g=d.controlFactory.create(g))&&d.controls.push(g);return jQuery.extend(this,c)};a.prototype.merge=function(a,d){var b;b=c(this,a);return b=f(b,d)};a.prototype.setDeepLinks=function(a){var d,b,h,l=[],k;for(k=0;k<a.length;k++){d=a[k];b=d.controlName;var m=[];h=void 0;for(var n=0;n<this.controls.length;n++)h=
this.controls[n],h.name===b&&m.push(h);b=m;for(m=0;m<b.length;m++)h=b[m],jQuery.isFunction(h.getStatusByDeepLink)&&(h=h.getStatusByDeepLink(d.propName,d.propValue))&&l.push(h)}a=c(this,!1);for(k=0;k<l.length;k++)f(a,l[k]);this.observer.trigger(this.observer.events.renderStatusesEvent,[a])};a.prototype.setStatuses=function(a,d){for(var b,c,f=0;f<a.length;f++){b=a[f];c=b.name;for(var k=b.action,m=[],n=void 0,p=0;p<this.controls.length;p++)n=this.controls[p],n.name===c&&n.action===k&&m.push(n);c=m;for(k=
0;k<c.length;k++)jQuery.isFunction(c[k].setStatus)&&c[k].setStatus(b,d)}};a.prototype.getDeepLinksUrl=function(){var a;a="";for(var d=[],b="",c=0;c<this.controls.length;c++)a=this.controls[c],jQuery.isFunction(a.getDeepLink)&&(b=jQuery.trim(a.getDeepLink())),""!==b&&-1===jQuery.inArray(b,d)&&d.push(b);return a=d.join(this.options.delimiter1)};a.prototype.getStatuses=function(a){return c(this,a)};a.prototype.getPaths=function(){var a,d=[],g;g=new b.dom.collections.DataItemMemberPathCollection(this.options,
...
this.observer.trigger(this.observer.events.statusEvent,[a])):(c.removeClass("active"),b=this.$control.find('li:has([data-number="'+a.data.number+'"])'),0===b.length&&(b=this.$control.find('li:has([data-number="all"])')),0>=b.length&&(b=c.eq(0)),b.addClass("active"),this.$control.find(".jplist-dd-panel").text(b.eq(0).text()))}};jQuery.fn.jplist.ui.controls.Dropdown=function(e){return new a(e)}})();(function(){var b=function(a,b){var g,c=null,f="",k="";g=a.$control.data("storage-status");if(b&&g)c=g;else switch(b?(g=a.$control.find('option[data-default="true"]').eq(0),0>=g.length&&(g=a.$control.find("option").eq(0))):g=a.$control.find("option:selected"),a.action){case "paging":c=new jQuery.fn.jplist.ui.controls.DropdownPaginationDTO(g.attr("data-number"));c=new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,c,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking);break;case "sort":f=
a.$control.attr("data-datetime-format")||"";k=a.$control.attr("data-ignore")||"";c=new jQuery.fn.jplist.ui.controls.DropdownSortDTO(g.attr("data-path"),g.attr("data-type"),g.attr("data-order"),f,k);c=new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,c,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking);break;case "filter":c=new jQuery.fn.jplist.ui.controls.DropdownFilterDTO(g.attr("data-path"),g.attr("data-type")),c=new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,
...
null),a.$control.data("path",b));a.$control.data("dataMode",h);a.$control.data("dataType",l);a.$control.data("dataPath",d);a.$control.data("dataText",c);a.$control.data("dataMin",k);a.$control.data("dataMax",m);f(a);return jQuery.extend(this,a)};jQuery.fn.jplist.ui.controls.Counter=function(a){return new c(a)}})();(function(){var b=function(a){var b,d={},c,h;b=a.controlOptions;c=a.$control.find('[data-type="prev"]');h=a.$control.find('[data-type="next"]');a.$control.data("jplist-datepicker-range-prev",c);a.$control.data("jplist-datepicker-range-next",h);c.off().change(function(){""===jQuery.trim(jQuery(this).val())&&(a.history.addStatus(f(a,!1)),a.observer.trigger(a.observer.events.forceRenderStatusesEvent,[!1]))});h.off().change(function(){""===jQuery.trim(jQuery(this).val())&&(a.history.addStatus(f(a,!1)),
...
c);a.observer.trigger(a.observer.events.renderStatusesEvent,[f])}else a.observer.trigger(a.observer.events.forceRenderStatusesEvent,[!0]);b(a)})},c=function(a){b(a);f(a);return jQuery.extend(this,a)};jQuery.fn.jplist.ui.controls.BackButton=function(a){return new c(a)}})();(function(){var b=function(b){b.observer.on(b.observer.events.renderStatusesEvent,function(a){b.$control.removeClass("jplist-hide-preloader")});b.observer.on(b.observer.events.setStatusesEvent,function(a,e,d){b.$control.addClass("jplist-hide-preloader")})},f=function(c){b(c);return jQuery.extend(this,c)};jQuery.fn.jplist.ui.controls.Preloader=function(b){return new f(b)}})();(function(){var b=function(b){b.params={};return jQuery.extend(this,b)};jQuery.fn.jplist.ui.itemControls.StarRating=function(f){return new b(f)}})();
