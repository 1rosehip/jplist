/*
 jPList - jQuery Data Grid Controls 5.1.111 - http://jplist.com 
...
jQuery.fn.jplist.domain.dom.models.DataItemModel=function(b,e,a){b=new c(b,e,a);this.html=b.html;this.jqElement=b.$item;this.pathitems=b.pathitems;this.findPathitem=b.findPathitem}})();(function(){var c=function(a,d){var b,e,f;b=(new jQuery.fn.jplist.app.dto.StatusesDTOCollection(a.options,a.observer,d)).getStatusesByAction("filter",d);if(0<b.length){for(var c=0;c<b.length;c++)if((e=b[c])&&e.data&&e.data.filterType)f=jQuery.fn.jplist.app.services.DTOMapperService.filters[e.data.filterType],jQuery.isFunction(f)&&(a.dataview=f(e,a.dataview));a.observer.trigger(a.observer.events.filterEvent,[d,a])}},b=function(a,d){var b,e=null,f;b=(new jQuery.fn.jplist.app.dto.StatusesDTOCollection(a.options,
a.observer,d)).getStatusesByAction("paging",d);if(0<b.length){for(var c=0;c<b.length;c++)e=b[c],f=e.data.currentPage||0,e=new jQuery.fn.jplist.domain.dom.services.PaginationService(f,e.data.number,a.dataview.length),b[c].data.paging=e,a.dataview=jQuery.fn.jplist.domain.dom.services.FiltersService.pagerFilter(e,a.dataview);a.observer.trigger(a.observer.events.paginationEvent,[d,a])}},e=function(a,d){var b;b=(new jQuery.fn.jplist.app.dto.StatusesDTOCollection(a.options,a.observer,d)).getStatusesByAction("sort",
d);0<b.length&&(jQuery.fn.jplist.domain.dom.services.SortService.doubleSort(b,a.dataview),a.observer.trigger(a.observer.events.sortEvent,[d,a]))},a=function(a){return jQuery(a.dataview).map(function(a,d){return d.jqElement.get()})},d=function(a){return jQuery(a.dataitems).map(function(a,d){return d.jqElement.get()})},f=function(a){a.dataview=jQuery.merge([],a.dataitems)},g=function(a,d){for(var b,e=-1,f,c=0;c<a.dataitems.length;c++)if(b=a.dataitems[c],b=jQuery.fn.jplist.domain.dom.services.HelperService.getOuterHtml(b.jqElement),
f=jQuery.fn.jplist.domain.dom.services.HelperService.getOuterHtml(d),b===f){e=c;break}return e},h=function(a,d){var b;b=g(a,d);-1!==b&&(a.dataitems.splice(b,1),a.observer.trigger(a.observer.events.delItemEvent,[d,a.dataitems]))},k=function(a,d){d.each(function(){h(a,jQuery(this))})},l=function(a,d,b,e){d=new jQuery.fn.jplist.domain.dom.models.DataItemModel(d,b,e);a.dataitems.push(d);a.observer.trigger(a.observer.events.addItemEvent,[d,a.dataitems])},n=function(a,d,b,e){for(var f;b<d.length;b++)f=
d.eq(b),l(a,f,e,b),b+1<d.length&&0===b%50&&window.setTimeout(function(){n(a,d,b,e)},0)},m=function(a,d,b,e){a={dataitems:[],dataview:[],options:a,observer:d};0<b.length&&(n(a,b,0,e),f(a));a.observer.trigger(a.observer.events.collectionReadyEvent,[a]);return jQuery.extend(this,a)};m.prototype.applyStatuses=function(a){f(this);e(this,a);c(this,a);b(this,a);this.observer.trigger(this.observer.events.renderList,[this,a])};m.prototype.filter=function(a){c(this,a)};m.prototype.sort=function(a){e(this,a)};
...
function(a){return g(this,a)};m.prototype.dataviewToString=function(){var a,d="",b;for(b=0;b<this.dataview.length;b++)a=this.dataview[b],d+=a.content;return d};jQuery.fn.jplist.domain.dom.collections.DataItemsCollection=function(a,d,b,e){b=new m(a,d,b,e);this.observer=d;this.options=a;this.dataitems=b.dataitems;this.dataview=b.dataview;this.sort=b.sort;this.filter=b.filter;this.pagination=b.pagination;this.applyStatuses=b.applyStatuses;this.addDataItem=b.addDataItem;this.addDataItems=b.addDataItems;
...
for(var a=a+("<"+b),g=0;g<d.length;g++)d[g].nodeValue&&(a+=" "+d[g].nodeName+"=",a+='"'+d[g].nodeValue+'"');a=a+">"+c;return a+="</"+b+">"};jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters=function(b,a){return!b?"":b.replace(RegExp(a,"ig"),"").toLowerCase()};jQuery.fn.jplist.domain.dom.services.HelperService.formatDateTime=function(e,a){var d,f,g,h,k,l;a=a.replace(/\./g,"\\.");a=a.replace(/\(/g,"\\(");a=a.replace(/\)/g,"\\)");a=a.replace(/\[/g,"\\[");a=a.replace(/\]/g,"\\]");d=
