...
<head>
    ...
    <title>jPList Bootstrap Pagination Localstorage PHP MySQL | jPList - jQuery Data Grid Controls</title>
...
<div class="page" id="demo">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h1 class="text-center">jPList Bootstrap Pagination Localstorage PHP MySQL</h1>
            </div>
        ...
        <script>
            $('document').ready(function () {
                ...
                $('#demo').jplist({
                    ...
                    , storageName: 'tests-bootstrap-pagination-storage-php'
